...
var ea = (b, f, k) => f.has(b) || _l("Cannot " + k);
var O = (b, f, k) => (ea(b, f, "read from private field"), k ? k.call(b) : f.get(b)), at = (b, f, k) => f.has(b) ? _l("Cannot add the same private member more than once") : f instanceof WeakSet ? f.add(b) : f.set(b, k), q = (b, f, k, C) => (ea(b, f, "write to private field"), C ? C.call(b, k) : f.set(b, k), k), mt = (b, f, k) => (ea(b, f, "access private method"), k);
var Tr = (b, f, k, C) => ({
  set _(I) {
    q(b, f, I, k);
  },
...
function tg() {
  ...
  Zl = 1;
  var b = Jf;
  return Ar.createRoot = b.createRoot, Ar.hydrateRoot = b.hydrateRoot, Ar;
}
var eg = tg(), ig = Object.defineProperty, sg = (b, f, k) => f in b ? ig(b, f, { enumerable: !0, configurable: !0, writable: !0, value: k }) : b[f] = k, Or = (b, f, k) => sg(b, typeof f != "symbol" ? f + "" : f, k);
const rg = {
...
const Pr = Symbol.for("r2wc.render"), Lr = Symbol.for("r2wc.connected"), gi = Symbol.for("r2wc.context"), Re = Symbol.for("r2wc.props");
function dg(b, f, k) {
  var C, I, F;
  ...
  class nt extends HTMLElement {
    constructor() {
      super(), Or(this, F, !0), Or(this, I), Or(this, C, {}), Or(this, "container"), f.shadow ? this.container = this.attachShadow({
        mode: f.shadow
      }) : this.container = this, this[Re].container = this.container;
      for (const K of z) {
        const J = st[K], _ = this.getAttribute(J), ft = Y[K], H = ft ? ia[ft] : null;
    ...
    disconnectedCallback() {
      this[Lr] = !1, this[gi] && k.unmount(this[gi]), delete this[gi];
    }
    attributeChangedCallback(K, J, _) {
      const ft = U[K], H = Y[ft], tt = H ? ia[H] : null;
      ft in Y && tt != null && tt.parse && _ && (this[Re][ft] = tt.parse(_, K, this), this[Pr]());
    }
    [(F = Lr, I = gi, C = Re, Pr)]() {
      this[Lr] && (this[gi] ? k.update(this[gi], this[Re]) : this[gi] = k.mount(
        this.container,
        b,
        this[Re]
      ));
...
function cg(b, f, k) {
  const C = eg.createRoot(b), I = Br.createElement(f, k);
  return C.render(I), {
    root: C,
    ReactComponent: f
  };
}
function ug({ root: b, ReactComponent: f }, k) {
  const C = Br.createElement(f, k);
  b.render(C);
}
function pg({ root: b }) {
  b.unmount();
...
function fg(b, f = {}) {
  return dg(b, f, { mount: cg, update: ug, unmount: pg });
}
var sa = { exports: {} }, Cs = {};
/**
 * @license React
...
function gg() {
  if (Jl) return Cs;
  Jl = 1;
  var b = Br, f = Symbol.for("react.element"), k = Symbol.for("react.fragment"), C = Object.prototype.hasOwnProperty, I = b.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, F = { key: !0, ref: !0, __self: !0, __source: !0 };
  function z(W, Y, rt) {
...
var th;
function mg() {
  return th || (th = 1, sa.exports = gg()), sa.exports;
}
var te = mg();
const yg = async (b) => {
  ...
  return await f.json();
}, xg = "https://3792f998-96be-4327-8204-4d908ecf4e19.mock.pstmn.io", bg = async () => await yg(`${xg}/site-overview`);
var Rs = class {
  constructor() {
...
function As(b) {
  return JSON.stringify(
    b,
    (f, k) => na(k) ? Object.keys(k).sort().reduce((C, I) => (C[I] = k[I], C), {}) : k
  );
}
function Os(b, f) {
...
function Th(b, f) {
  ...
  if (k || na(b) && na(f)) {
    ...
    for (let rt = 0; rt < z; rt++) {
      const st = k ? rt : F[rt];
      (!k && C.includes(st) || k) && b[st] === void 0 && f[st] === void 0 ? (W[st] = void 0, Y++) : (W[st] = Th(b[st], f[st]), W[st] === b[st] && b[st] !== void 0 && Y++);
    }
    return I === z && Y === I ? b : W;
  }
  return f;
...
function na(b) {
  ...
  if (f === void 0)
    return !0;
  const k = f.prototype;
  return !(!rh(k) || !k.hasOwnProperty("isPrototypeOf") || Object.getPrototypeOf(b) !== Object.prototype);
}
function rh(b) {
...
function la(b, f, k) {
  return typeof k.structuralSharing == "function" ? k.structuralSharing(b, f) : k.structuralSharing !== !1 ? Th(b, f) : f;
}
function kg(b, f, k = 0) {
  const C = [...b, f];
...
var ba = Symbol();
function Ah(b, f) {
  return !b.queryFn && (f != null && f.initialPromise) ? () => f.initialPromise : !b.queryFn || b.queryFn === ba ? () => Promise.reject(new Error(`Missing queryFn: '${b.queryHash}'`)) : b.queryFn;
}
var mi, Qe, Xi, gh, Mg = (gh = class extends Rs {
  constructor() {
    super();
    at(this, mi);
    at(this, Qe);
...
}, mi = new WeakMap(), Qe = new WeakMap(), Xi = new WeakMap(), gh), va = new Mg(), Gi, _e, Yi, mh, Cg = (mh = class extends Rs {
  constructor() {
    super();
    at(this, Gi, !0);
    at(this, _e);
...
}, Gi = new WeakMap(), _e = new WeakMap(), Yi = new WeakMap(), mh), Dr = new Cg();
function ha() {
  let b, f;
...
function Oh(b) {
  return (b ?? "online") === "online" ? Dr.isOnline() : !0;
}
...
function ra(b) {
  return b instanceof Ph;
}
function Lh(b) {
  let f = !1, k = 0, C = !1, I;
  const F = ha(), z = (J) => {
    var _;
    C || (nt(new Ph(J)), (_ = b.abort) == null || _.call(b));
  }, W = () => {
    f = !0;
  }, Y = () => {
    f = !1;
  }, rt = () => va.isFocused() && (b.networkMode === "always" || Dr.isOnline()) && b.canRun(), st = () => Oh(b.networkMode) && b.canRun(), U = (J) => {
    var _;
    ...
    Promise.resolve(J).then(U).catch((ft) => {
      ...
      if (C)
        return;
      const H = b.retry ?? (Mi ? 0 : 3), tt = b.retryDelay ?? Tg, ht = typeof tt == "function" ? tt(k, ft) : tt, xt = H === !0 || typeof H == "number" && k < H || typeof H == "function" && H(k, ft);
      if (f || !xt) {
        nt(ft);
        return;
      }
      k++, (It = b.onFail) == null || It.call(b, k, ft), wg(ht).then(() => rt() ? void 0 : $()).then(() => {
        f ? nt(ft) : K();
      });
    });
  };
...
var Ut = Og(), yi, yh, Eh = (yh = class {
  ...
  scheduleGc() {
    this.clearGcTimeout(), oa(this.gcTime) && q(this, yi, setTimeout(() => {
      this.optionalRemove();
    }, this.gcTime));
  }
  updateGcTime(b) {
...
}, yi = new WeakMap(), yh), Ui, qi, de, xi, qt, Ps, bi, ye, De, xh, Pg = (xh = class extends Eh {
  constructor(f) {
    super();
    at(this, ye);
    at(this, Ui);
    ...
    at(this, Ps);
    at(this, bi);
    q(this, bi, !1), q(this, Ps, f.defaultOptions), this.setOptions(f.options), this.observers = [], q(this, xi, f.client), q(this, de, O(this, xi).getQueryCache()), this.queryKey = f.queryKey, this.queryHash = f.queryHash, q(this, Ui, Lg(this.options)), this.state = f.state ?? O(this, Ui), this.scheduleGc();
  }
  get meta() {
  ...
  setData(f, k) {
    const C = la(this.state.data, f, this.options);
  ...
  isDisabled() {
    return this.getObserversCount() > 0 ? !this.isActive() : this.options.queryFn === ba || this.state.dataUpdateCount + this.state.errorUpdateCount === 0;
  }
  isStale() {
  ...
  isStaleByTime(f = 0) {
    return this.state.isInvalidated || this.state.data === void 0 || !Ch(this.state.dataUpdatedAt, f);
  }
  onFocus() {
    var k;
  ...
  fetch(f, k) {
    ...
    const W = (U) => {
      var nt, $, K, J;
      ra(U) && U.silent || mt(this, ye, De).call(this, {
        type: "error",
        error: U
      }), ra(U) || (($ = (nt = O(this, de).config).onError) == null || $.call(
        nt,
        U,
        this
  ...
  const k = (C) => {
    switch (f.type) {
      ...
      case "error":
        const I = f.error;
        return ra(I) && I.revert && O(this, qi) ? { ...O(this, qi), fetchStatus: "idle" } : {
          ...C,
          error: I,
...
function Ih(b, f) {
  return {
    fetchFailureCount: 0,
    fetchFailureReason: null,
    fetchStatus: Oh(f.networkMode) ? "fetching" : "paused",
    ...b === void 0 && {
      error: null,
      status: "pending"
    }
...
var Te, bh, Eg = (bh = class extends Rs {
  constructor(f = {}) {
    super();
    at(this, Te);
  ...
  build(f, k, C) {
    const I = k.queryKey, F = k.queryHash ?? xa(I, k);
    let z = this.get(F);
    return z || (z = new Pg({
      client: f,
      queryKey: I,
  ...
  findAll(f = {}) {
    const k = this.getAll();
    return Object.keys(f).length > 0 ? k.filter((C) => eh(f, C)) : k;
  }
  notify(f) {
    Ut.batch(() => {
      this.listeners.forEach((k) => {
...
}, Te = new WeakMap(), bh), Ae, _t, vi, Oe, Ke, vh, Ig = (vh = class extends Eh {
  constructor(f) {
    super();
    at(this, Oe);
    at(this, Ae);
    at(this, _t);
    at(this, vi);
    this.mutationId = f.mutationId, q(this, _t, f.mutationCache), q(this, Ae, []), this.state = f.state || Rg(), this.setOptions(f.options), this.scheduleGc();
  }
  setOptions(f) {
...
var Ne, xe, Ls, wh, Dg = (wh = class extends Rs {
  constructor(f = {}) {
    super();
    at(this, Ne);
    at(this, xe);
  ...
  findAll(f = {}) {
    return this.getAll().filter((k) => ih(f, k));
  }
  notify(f) {
    Ut.batch(() => {
      this.listeners.forEach((k) => {
...
}, Ne = new WeakMap(), xe = new WeakMap(), Ls = new WeakMap(), wh);
function Er(b) {
  var f;
  ...
  return {
    onFetch: (f, k) => {
      ...
      const rt = async () => {
        ...
        const _ = (tt) => {
        ...
        }, ft = Ah(f.options, f.fetchOptions), H = async (tt, ht, xt) => {
          if (J)
          ...
          const pe = await ft(
            It
          ), { maxPages: E } = f.options, Ct = xt ? Sg : kg;
          return {
        ...
        if (I && F.length) {
          const tt = I === "backward", ht = tt ? Bg : ah, xt = {
            pages: F,
            pageParams: z
          }, It = ht(C, xt);
          W = await H(xt, It, tt);
          ...
          const tt = b ?? F.length;
          do {
            const ht = Y === 0 ? z[0] ?? C.initialPageParam : ah(C, W);
            if (Y > 0 && ht == null)
              break;
            W = await H(W, ht), Y++;
          } while (Y < tt);
...
function ah(b, { pages: f, pageParams: k }) {
  const C = f.length - 1;
...
var Dt, Ze, Je, $i, Vi, ti, Ki, Qi, kh, Ng = (kh = class {
  constructor(b = {}) {
    ...
    at(this, Ki);
    at(this, Qi);
    q(this, Dt, b.queryCache || new Eg()), q(this, Ze, b.mutationCache || new Dg()), q(this, Je, b.defaultOptions || {}), q(this, $i, /* @__PURE__ */ new Map()), q(this, Vi, /* @__PURE__ */ new Map()), q(this, ti, 0);
  }
  mount() {
    Tr(this, ti)._++, O(this, ti) === 1 && (q(this, Ki, va.subscribe(async (b) => {
      b && (await this.resumePausedMutations(), O(this, Dt).onFocus());
    })), q(this, Qi, Dr.subscribe(async (b) => {
  ...
  setQueryData(b, f, k) {
    const C = this.defaultQueryOptions({ queryKey: b }), I = O(this, Dt).get(
      C.queryHash
    ), F = I == null ? void 0 : I.state.data, z = vg(f, F);
    if (z !== void 0)
  ...
  fetchInfiniteQuery(b) {
    return b.behavior = oh(b.pages), this.fetchQuery(b);
  }
  prefetchInfiniteQuery(b) {
    return this.fetchInfiniteQuery(b).then(ce).catch(ce);
  }
  ensureInfiniteQueryData(b) {
    return b.behavior = oh(b.pages), this.ensureQueryData(b);
  }
  resumePausedMutations() {
    return Dr.isOnline() ? O(this, Ze).resumePausedMutations() : Promise.resolve();
  }
  getQueryCache() {
    return O(this, Dt);
  }
  ...
  defaultQueryOptions(b) {
    ...
    return f.queryHash || (f.queryHash = xa(
      f.queryKey,
      f
    )), f.refetchOnReconnect === void 0 && (f.refetchOnReconnect = f.networkMode !== "always"), f.throwOnError === void 0 && (f.throwOnError = !!f.suspense), !f.networkMode && f.persister && (f.networkMode = "offlineFirst"), f.queryFn === ba && (f.enabled = !1), f;
  }
...
}, Dt = new WeakMap(), Ze = new WeakMap(), Je = new WeakMap(), $i = new WeakMap(), Vi = new WeakMap(), ti = new WeakMap(), Ki = new WeakMap(), Qi = new WeakMap(), kh), Jt, yt, Es, Zt, wi, _i, ei, ii, Is, Zi, Ji, ki, Si, si, ts, wt, Ts, da, ca, ua, pa, fa, ga, ma, Rh, Sh, zg = (Sh = class extends Rs {
  constructor(f, k) {
    super();
    at(this, wt);
    at(this, Jt);
    ...
    this.options = k, q(this, Jt, f), q(this, ii, null), q(this, ei, ha()), this.options.experimental_prefetchInRender || O(this, ei).reject(
  ...
  onSubscribe() {
    this.listeners.size === 1 && (O(this, yt).addObserver(this), nh(O(this, yt), this.options) ? mt(this, wt, Ts).call(this) : this.updateResult(), mt(this, wt, pa).call(this));
  }
  onUnsubscribe() {
  ...
  destroy() {
    this.listeners = /* @__PURE__ */ new Set(), mt(this, wt, fa).call(this), mt(this, wt, ga).call(this), O(this, yt).removeObserver(this);
  }
  setOptions(f) {
    ...
    mt(this, wt, ma).call(this), O(this, yt).setOptions(this.options), k._defaulted && !aa(this.options, k) && O(this, Jt).getQueryCache().notify({
    ...
    I && lh(
      ...
      this.options,
      k
    ) && mt(this, wt, Ts).call(this), this.updateResult(), I && (O(this, yt) !== C || be(this.options.enabled, O(this, yt)) !== be(k.enabled, O(this, yt)) || ji(this.options.staleTime, O(this, yt)) !== ji(k.staleTime, O(this, yt))) && mt(this, wt, da).call(this);
    const F = mt(this, wt, ca).call(this);
    I && (O(this, yt) !== C || be(this.options.enabled, O(this, yt)) !== be(k.enabled, O(this, yt)) || F !== O(this, si)) && mt(this, wt, ua).call(this, F);
  }
  getOptimisticResult(f) {
    const k = O(this, Jt).getQueryCache().build(O(this, Jt), f), C = this.createResult(k, f);
    return Wg(this, C) && (q(this, Zt, C), q(this, _i, this.options), q(this, wi, O(this, yt).state)), C;
  }
  getCurrentResult() {
    return O(this, Zt);
  }
  ...
  createResult(f, k) {
    ...
    if (k._optimisticResults) {
      const kt = this.hasListeners(), $t = !kt && nh(f, k), se = kt && lh(f, C, k, I);
      ($t || se) && (U = {
        ...U,
        ...Ih(st.data, f.options)
    ...
    if (k.placeholderData !== void 0 && $ === void 0 && _ === "pending") {
      ...
      F != null && F.isPlaceholderData && k.placeholderData === (W == null ? void 0 : W.placeholderData) ? (kt = F.data, ft = !0) : kt = typeof k.placeholderData == "function" ? k.placeholderData(
        ...
        O(this, Ji)
      ) : k.placeholderData, kt !== void 0 && (_ = "success", $ = la(
    ...
    if (k.select && $ !== void 0 && !ft)
      if (F && $ === (z == null ? void 0 : z.data) && k.select === O(this, Is))
        ...
        try {
          q(this, Is, k.select), $ = k.select($), $ = la(F == null ? void 0 : F.data, $, k), q(this, Zi, $), q(this, ii, null);
        } catch (kt) {
          q(this, ii, kt);
        }
    ...
    if (this.options.experimental_prefetchInRender) {
      const kt = (ri) => {
        ...
        const ri = q(this, ei, E.promise = ha());
        kt(ri);
      }, se = O(this, ei);
      switch (se.status) {
        case "pending":
  ...
  updateResult() {
    ...
    if (q(this, wi, O(this, yt).state), q(this, _i, this.options), O(this, wi).data !== void 0 && q(this, Ji, O(this, yt)), aa(k, f))
      return;
    q(this, Zt, k);
    const C = () => {
      if (!f)
    ...
    mt(this, wt, Rh).call(this, { listeners: C() });
  }
  onQueryUpdate() {
    this.updateResult(), this.hasListeners() && mt(this, wt, pa).call(this);
  }
  ...
  mt(this, wt, fa).call(this);
  const f = ji(
    this.options.staleTime,
    O(this, yt)
  );
  if (Mi || O(this, Zt).isStale || !oa(f))
    return;
  const C = Ch(O(this, Zt).dataUpdatedAt, f) + 1;
  ...
  mt(this, wt, ga).call(this), q(this, si, f), !(Mi || be(this.options.enabled, O(this, yt)) === !1 || !oa(O(this, si)) || O(this, si) === 0) && q(this, Si, setInterval(() => {
    (this.options.refetchIntervalInBackground || va.isFocused()) && mt(this, wt, Ts).call(this);
  }, O(this, si)));
}, pa = function() {
  mt(this, wt, da).call(this), mt(this, wt, ua).call(this, mt(this, wt, ca).call(this));
}, fa = function() {
...
function nh(b, f) {
  return Fg(b, f) || b.state.data !== void 0 && ya(b, f, f.refetchOnMount);
}
function ya(b, f, k) {
  if (be(f.enabled, b) !== !1) {
    const C = typeof k == "function" ? k(b) : k;
    return C === "always" || C !== !1 && wa(b, f);
  }
  return !1;
}
function lh(b, f, k, C) {
  return (b !== f || be(C.enabled, b) === !1) && (!k.suspense || b.state.status !== "error") && wa(b, k);
}
function wa(b, f) {
  return be(f.enabled, b) !== !1 && b.isStaleByTime(ji(f.staleTime, b));
}
function Wg(b, f) {
  return !aa(b.getCurrentResult(), f);
}
var Dh = ue.createContext(
  void 0
), Hg = (b) => {
  const f = ue.useContext(Dh);
  if (!f)
  ...
  b.unmount();
}), [b]), /* @__PURE__ */ te.jsx(Dh.Provider, { value: b, children: f })), Bh = ue.createContext(!1), Xg = () => ue.useContext(Bh);
Bh.Provider;
function Gg() {
  let b = !1;
  return {
...
var Yg = ue.createContext(Gg()), Ug = () => ue.useContext(Yg);
function qg(b, f) {
  return typeof b == "function" ? b(...f) : !!b;
}
function hh() {
...
var $g = (b, f) => {
  ...
  query: C,
  suspense: I
}) => b.isError && !f.isReset() && !b.isFetching && C && (I && b.data === void 0 || qg(k, [b.error, C])), Qg = (b) => {
  const f = b.staleTime;
...
}, _g = (b, f) => b.isLoading && b.isFetching && !f, Zg = (b, f) => (b == null ? void 0 : b.suspense) && f.isPending, dh = (b, f, k) => f.fetchOptimistic(b).catch(() => {
  k.clearReset();
});
function Jg(b, f, k) {
  var U, nt, $, K, J;
  const C = Hg(), I = Xg(), F = Ug(), z = C.defaultQueryOptions(b);
  (nt = (U = C.getDefaultOptions().queries) == null ? void 0 : U._experimental_beforeQuery) == null || nt.call(
    U,
    z
  ), z._optimisticResults = I ? "isRestoring" : "optimistic", Qg(z), $g(z, F), Vg(F);
  ...
  if (ue.useSyncExternalStore(
    ue.useCallback(
      (_) => {
        const ft = st ? Y.subscribe(Ut.batchCalls(_)) : hh;
  ...
  if ((K = ($ = C.getDefaultOptions().queries) == null ? void 0 : $._experimental_afterQuery) == null || K.call(
    ...
    z,
    rt
  ), z.experimental_prefetchInRender && !Mi && _g(rt, I)) {
    const _ = W ? (
...
const Be = {
  ...
  plotOptions: {
    pie: {
      ...
      borderWidth: ch.PIE.BORDER_WIDTH,
      cursor: "pointer"
    }
  },
  series: [
...
var Ir = { exports: {} }, rm = Ir.exports, uh;
function om() {
  return uh || (uh = 1, function(b, f) {
    (function(k, C) {
      k._Highcharts = C(), b.exports = k._Highcharts;
    })(typeof window > "u" ? rm : window, () => (() => {
      var Kl;
      let k, C;
      ...
      function se(h, t, e, i) {
        ...
        let r = zr(h), o = r ? `${s} #${h}: www.highcharts.com/errors/${h}/` : h.toString();
        if (i !== void 0) {
          let a = "";
 ...
 - ${l}: ${n}`, r && (o += encodeURI(l) + "=" + encodeURI(n));
        ...
        Oa(E, "displayError", { chart: e, code: h, message: o, params: i }, function() {
          if (t) throw Error(o);
      ...
      function ka(h) {
        ...
        return !!(Ci(h, !0) && !Nr(h) && (t != null && t.name) && t.name !== "Object");
      }
      function zr(h) {
      ...
      let Nh = Array.prototype.find ? function(h, t) {
        return h.find(t);
      } : function(h, t) {
        let e, i = h.length;
      ...
      $t.jQuery && ($t.jQuery.fn.highcharts = function() {
        ...
        if (this[0]) return h[0] ? (new E[es(h[0]) ? h.shift() : "Chart"](this[0], h[0], h[1]), this) : Ct[Sa(this[0], "data-highcharts-chart")];
      });
      let V = { addEvent: function(h, t, e, i = {}) {
        ...
        for (; t--; ) h[t] < e && (e = h[t]);
        return e;
      }, attr: Sa, clamp: function(h, t, e) {
        return h > t ? h < e ? h : e : t;
      }, clearTimeout: function(h) {
        Ti(h) && clearTimeout(h);
      }, correctFloat: Ta, createElement: function(h, t, e, i, s) {
        let r = kt.createElement(h);
        return t && Ai(r, t), s && Fr(r, { padding: "0", border: "none", margin: "0" }), e && Fr(r, e), i && i.appendChild(r), r;
      }, crisp: function(h, t = 0, e) {
        let i = t % 2 / 2, s = e ? -1 : 1;
        return (Math.round(h * s - i) + i) * s;
      }, css: Fr, defined: Ti, destroyObjectProperties: function(h, t, e) {
        oi(h, function(i, s) {
      ...
      }, find: Nh, fireEvent: Oa, getAlignFactor: (h = "") => ({ center: 0.5, right: 1, middle: 0.5, bottom: 1 })[h] || 0, getClosestDistance: function(h, t) {
        let e, i, s, r = !t;
        return h.forEach((o) => {
          if (o.length > 1) for (s = o.length - 1; s > 0; s--) (i = o[s] - o[s - 1]) < 0 && !r ? (t == null || t(), t = void 0) : i && (e === void 0 || i < e) && (e = i);
        }), e;
      }, getMagnitude: Ca, getNestedProperty: function(h, t) {
        let e = h.split(".");
        for (; e.length && Ti(t); ) {
          let i = e.shift();
        ...
        for (e = h.options.isInternal ? s : 0; e < s + 1; e++) if (!t[e] || zr(i) && i < is(t[e].options.index, t[e]._i) || t[e].options.isInternal) {
          t.splice(e, 0, h);
          break;
        }
        return e;
      }, isArray: Ds, isClass: ka, isDOMElement: Nr, isFunction: function(h) {
        return typeof h == "function";
      }, isNumber: zr, isObject: Ci, isString: es, merge: function(h, ...t) {
        let e, i = [h, ...t], s = {}, r = function(a, n) {
          return typeof a != "object" && (a = {}), oi(n, function(l, c) {
            c !== "__proto__" && c !== "constructor" && (!Ci(l, !0) || ka(l) || Nr(l) ? a[c] = n[c] : a[c] = r(a[c] || {}, l));
          }), a;
        };
        ...
        return Ta(o * e, -Math.round(Math.log(1e-3) / Math.LN10));
      ...
      }, removeEvent: Aa, replaceNested: function(h, ...t) {
        let e, i;
        do
          for (i of (e = h, t)) h = h.replace(i[0], i[1]);
        while (h !== e);
        return h;
      }, splat: Ma, stableSort: function(h, t) {
        let e, i, s = h.length;
      ...
      }, uniqueKey: zh, useSerialIds: function(h) {
        return k = is(h, k);
      }, wrap: function(h, t, e) {
        let i = h[t];
        h[t] = function() {
      ...
      } }, { pageLang: Fh, win: Bs } = E, { defined: Pa, error: La, extend: Wr, isNumber: Ea, isObject: Hr, isString: ss, merge: Wh, objectEach: Hh, pad: ze, splat: jh, timeUnits: jr, ucfirst: Xh } = V, Gh = E.isSafari && Bs.Intl && !Bs.Intl.DateTimeFormat.prototype.formatRange, Yh = (h) => h.main === void 0, Uh = class {
        constructor(h, t) {
          this.options = { timezone: "UTC" }, this.variableTimezone = !1, this.Date = Bs.Date, this.update(h), this.lang = t;
        }
        update(h = {}) {
          this.dTLCache = {}, this.options = h = Wh(!0, this.options, h);
          let { timezoneOffset: t, useUTC: e } = h;
          this.Date = h.Date || Bs.Date || Date;
          let i = h.timezone;
          Pa(e) && (i = e ? "UTC" : void 0), t && t % 60 == 0 && (i = "Etc/GMT" + (t > 0 ? "+" : "") + t / 60), this.variableTimezone = i !== "UTC" && (i == null ? void 0 : i.indexOf("Etc/GMT")) !== 0, this.timezone = i, ["months", "shortMonths", "weekdays", "shortWeekdays"].forEach((s) => {
        ...
        dateTimeFormat(h, t, e = this.options.locale || Fh) {
          ...
          if (!s) {
            ...
            try {
              ...
              /Invalid time zone/i.test(r.message) ? (La(34), h.timeZone = "UTC", s = new Intl.DateTimeFormat(e, h)) : La(r.message, !1);
            }
          }
        ...
        makeTime(h, t, e = 1, i = 0, s, r, o) {
          ...
          if (this.timezone !== "UTC") {
            ...
            if (a += n, [2, 3, 8, 9, 10, 11].indexOf(t) !== -1 && (i < 5 || i > 20)) {
              ...
              n !== l ? a += l - n : n - 36e5 !== this.getTimezoneOffset(a - 36e5) || Gh || (a -= 36e5);
            }
          }
          return a;
        }
        parse(h) {
          ...
          t || e || (h += "Z");
          let i = Date.parse(h);
          if (Ea(i)) return i + (!t || e ? this.getTimezoneOffset(i) : 0);
        }
        getTimezoneOffset(h) {
          if (this.timezone !== "UTC") {
        ...
        dateFormat(h, t, e) {
          let i = this.lang;
          if (!Pa(t) || isNaN(t)) return (i == null ? void 0 : i.invalidDate) || "";
          ...
          if (ss(h) && h.indexOf("%") !== -1) {
            ...
            Hh(Wr({ a: g ? g[u] : p[u].substr(0, 3), A: p[u], d: ze(a), e: ze(a, 2, " "), w: u, v: (i == null ? void 0 : i.weekFrom) ?? "", b: y[o], B: x[o], m: ze(o + 1), o: o + 1, y: r.toString().substr(2, 2), Y: r, H: ze(n), k: n, I: ze(n % 12 || 12), l: n % 12 || 12, M: ze(l), p: n < 12 ? "AM" : "PM", P: n < 12 ? "am" : "pm", S: ze(c), L: ze(d, 3) }, E.dateFormats), function(m, v) {
            ...
            h = o + this.dateTimeFormat(Wr({ timeZone: r }, h), t) + a;
          }
          return e ? Xh(h) : h;
        }
        resolveDTLFormat(h) {
          return Hr(h, !0) ? Hr(h, !0) && Yh(h) ? { main: h } : h : { main: (h = jh(h))[0], from: h[1], to: h[2] };
        }
        getDateFormat(h, t, e, i) {
          ...
          for (a in jr) {
            if (h && h === jr.week && +this.dateFormat("%w", t) === e && s.substr(6) === r.substr(6)) {
              a = "week";
              break;
            }
            if (h && jr[a] > h) {
      ...
      }, { defined: Ia, extend: qh, timeUnits: Bt } = V, Xr = class extends Uh {
        getTimeTicks(h, t, e, i) {
          ...
          if (i ?? (i = 1), Ia(t)) {
            ...
            t = s.makeTime(l, c, d, u, p, g, x), s.variableTimezone && Ia(e) && (y = e - t > 4 * Bt.month || s.getTimezoneOffset(t) !== s.getTimezoneOffset(e));
            let m = t, v = 1;
      ...
      class At {
        ...
        brighten(t) {
          ...
          if (this.stops) this.stops.forEach(function(i) {
            ...
            else At.useColorMix && Yr(this.input) && (this.output = Da(this.input, t > 0 ? "white" : "black", Math.abs(t)));
          return this;
        }
        setOpacity(t) {
        ...
        tweenTo(t, e) {
          ...
          if (!rs(i[0]) || !rs(s[0])) return At.useColorMix && Yr(this.input) && Yr(t.input) && e < 0.99 ? Da(this.input, t.input, e) : t.input || "none";
      ...
      At.names = { white: "#ffffff", black: "#000000" }, At.parsers = [{ regex: /rgba\(\s*(\d{1,3})\s*,\s*(\d{1,3})\s*,\s*(\d{1,3})\s*,\s*(\d?(?:\.\d+)?)\s*\)/, parse: function(h) {
        ...
        return [Vt(h[1] + h[1], 16), Vt(h[2] + h[2], 16), Vt(h[3] + h[3], 16), Ra(h[4]) ? Vt(h[4] + h[4], 16) / 255 : 1];
      } }, { regex: /^#([a-f0-9]{2})([a-f0-9]{2})([a-f0-9]{2})([a-f0-9]{2})?$/i, parse: function(h) {
        return [Vt(h[1], 16), Vt(h[2], 16), Vt(h[3], 16), Ra(h[4]) ? Vt(h[4], 16) / 255 : 1];
      } }], At.useColorMix = (Kl = Qh.CSS) == null ? void 0 : Kl.supports("color", "color-mix(in srgb,red,blue 9%)"), At.None = new At("");
      let { parse: Ba } = At, { win: Jh } = E, { isNumber: Ur, objectEach: td } = V;
      class Kt {
        constructor(t, e, i) {
          ...
          if (s !== 1 && e && i)
            if (e.length === i.length && s < 1) for (let o = 0; o < i.length; o++) {
              ...
              for (let c = 0; c < n.length; c++) {
                let d = a[c], u = n[c];
                Ur(d) && Ur(u) && (n[0] !== "A" || c !== 4 && c !== 5) ? l[c] = d + s * (u - d) : l[c] = u;
              }
              r.push(l);
            }
            else r = i;
        ...
        run(t, e, i) {
          ...
          }, a = Jh.requestAnimationFrame || function(l) {
            setTimeout(l, 13);
          }, n = function() {
        ...
        step(t) {
          ...
          return o.attr && !o.element ? e = !1 : t || s >= n + this.startTime ? (this.now = this.end, this.pos = 1, this.update(), l[this.prop] = !0, i = !0, td(l, function(c) {
            c !== !0 && (i = !1);
        ...
        initPath(t, e, i) {
          ...
          return g.length && Ur(c) && (d = o.length + c * n, p ? (x(g, o), y(o)) : (x(o, g), y(g))), [g, o];
        }
        fillSetter() {
          Kt.prototype.strokeSetter.apply(this, arguments);
        }
        strokeSetter() {
          this.elem.attr(this.prop, Ba(this.start).tweenTo(Ba(this.end), this.pos), void 0, !0);
        }
      }
      Kt.timers = [];
      let { defined: ed, getStyle: id, isArray: sd, isNumber: rd, isObject: qr, merge: Na, objectEach: od, pick: ad } = V;
      function $r(h) {
        return qr(h) ? Na({ duration: 500, defer: 0 }, h) : { duration: 500 * !!h, defer: 0 };
      }
      function za(h, t) {
      ...
      let Xt = { animate: function(h, t, e) {
        let i, s = "", r, o, a;
        qr(e) || (a = arguments, e = { duration: a[2], easing: a[3], complete: a[4] }), rd(e.duration) || (e.duration = 400), e.easing = typeof e.easing == "function" ? e.easing : Math[e.easing] || Math.easeInOutSine, e.curAnim = Na(t), od(t, function(n, l) {
          za(h, l), o = new Kt(h, e, l), r = void 0, l === "d" && sd(t.d) ? (o.paths = o.initPath(h, h.pathArray, t.d), o.toD = t.d, i = 0, r = 1) : h.attr ? i = h.attr(l) : (i = parseFloat(id(h, l)) || 0, l !== "opacity" && (s = "px")), r || (r = n), typeof r == "string" && r.match("px") && (r = r.replace(/px/g, "")), o.run(i, r, s);
        });
      }, animObject: $r, getDeferredAnimation: function(h, t, e) {
        let i = $r(t), s = e ? [e] : h.series, r = 0, o = 0;
        return s.forEach((a) => {
          let n = $r(a.options.animation);
          r = qr(t) && ed(t.defer) ? i.defer : Math.max(r, n.duration + n.defer), o = Math.min(i.duration, n.duration);
        }), h.renderer.forExport && (r = 0), { defer: Math.max(0, r - o), duration: Math.min(r, o) };
      }, setAnimation: function(h, t) {
        t.renderer.globalAnimation = ad(h, t.options.chart.animation, !0);
      }, stop: za }, { SVG_NS: Fa, win: nd } = E, { attr: ld, createElement: hd, css: dd, error: Wa, isFunction: cd, isString: Ha, objectEach: ja, splat: ud } = V, { trustedTypes: Vr } = nd, Ns = Vr && cd(Vr.createPolicy) && Vr.createPolicy("highcharts", { createHTML: (h) => h }), pd = Ns ? Ns.createHTML("") : "";
      class Tt {
        static filterUserAttributes(t) {
          return ja(t, (e, i) => {
            let s = !0;
            Tt.allowedAttributes.indexOf(i) === -1 && (s = !1), ["background", "dynsrc", "href", "lowsrc", "src"].indexOf(i) !== -1 && (s = Ha(e) && Tt.allowedReferences.some((r) => e.indexOf(r) === 0)), s || (Wa(33, !1, void 0, { "Invalid attribute in config": `${i}` }), delete t[i]), Ha(e) && t[i] && (t[i] = e.replace(/</g, "&lt;"));
          }), t;
        }
        static parseStyle(t) {
        ...
        addToDOM(t) {
          return function e(i, s) {
            let r;
            return ud(i).forEach(function(o) {
              ...
              if (n)
                if (n === "#text") a = l;
                  ...
                  let d = n === "svg" ? Fa : s.namespaceURI || Fa, u = E.doc.createElementNS(d, n), p = o.attributes || {};
                  ja(o, function(g, x) {
                    x !== "tagName" && x !== "attributes" && x !== "children" && x !== "style" && x !== "textContent" && (p[x] = g);
                  }), ld(u, c ? p : Tt.filterUserAttributes(p)), o.style && dd(u, o.style), l && u.appendChild(l), e(o.children || [], u), a = u;
                } else Wa(33, !1, void 0, { "Invalid tagName in config": n });
      ...
      Tt.allowedAttributes = ["alt", "aria-controls", "aria-describedby", "aria-expanded", "aria-haspopup", "aria-hidden", "aria-label", "aria-labelledby", "aria-live", "aria-pressed", "aria-readonly", "aria-roledescription", "aria-selected", "class", "clip-path", "color", "colspan", "cx", "cy", "d", "dx", "dy", "disabled", "fill", "filterUnits", "flood-color", "flood-opacity", "height", "href", "id", "in", "in2", "markerHeight", "markerWidth", "offset", "opacity", "operator", "orient", "padding", "paddingLeft", "paddingRight", "patternUnits", "r", "radius", "refX", "refY", "role", "scope", "slope", "src", "startOffset", "stdDeviation", "stroke", "stroke-linecap", "stroke-width", "style", "tableValues", "result", "rowspan", "summary", "target", "tabindex", "text-align", "text-anchor", "textAnchor", "textLength", "title", "type", "valign", "width", "x", "x1", "x2", "xlink:href", "y", "y1", "y2", "zIndex"], Tt.allowedReferences = ["https://", "http://", "mailto:", "/", "../", "./", "#"], Tt.allowedTags = ["a", "abbr", "b", "br", "button", "caption", "circle", "clipPath", "code", "dd", "defs", "div", "dl", "dt", "em", "feComponentTransfer", "feComposite", "feDropShadow", "feFlood", "feFuncA", "feFuncB", "feFuncG", "feFuncR", "feGaussianBlur", "feMorphology", "feOffset", "feMerge", "feMergeNode", "filter", "h1", "h2", "h3", "h4", "h5", "h6", "hr", "i", "img", "li", "linearGradient", "marker", "ol", "p", "path", "pattern", "pre", "rect", "small", "span", "stop", "strong", "style", "sub", "sup", "svg", "table", "text", "textPath", "thead", "title", "tbody", "tspan", "td", "th", "tr", "u", "ul", "#text"], Tt.emptyHTML = pd, Tt.bypassHTMLFiltering = !1;
      let { defaultOptions: Xa, defaultTime: Ga } = re, { pageLang: fd } = E, { extend: gd, getNestedProperty: md, isArray: yd, isNumber: Ya, isObject: xd, isString: bd, pick: vd, ucfirst: wd } = V, zs = { add: (h, t) => h + t, divide: (h, t) => t !== 0 ? h / t : "", eq: (h, t) => h == t, each: function(h) {
        let t = arguments[arguments.length - 1];
        return !!yd(h) && h.map((e, i) => Fs(t.body, gd(xd(e) ? e : { "@this": e }, { "@index": i, "@first": i === 0, "@last": i === h.length - 1 }))).join("");
      }, ge: (h, t) => h >= t, gt: (h, t) => h > t, if: (h) => !!h, le: (h, t) => h <= t, lt: (h, t) => h < t, multiply: (h, t) => h * t, ne: (h, t) => h != t, subtract: (h, t) => h - t, ucfirst: wd, unless: (h) => !h }, Ua = {}, qa = (h) => /^["'].+["']$/.test(h);
      function Fs(h = "", t, e) {
        var y;
        let i = /\{([a-zA-Z\u00C0-\u017F\d:\.,;\-\/<>\[\]%_@+"'’= #\(\)]+)\}/g, s = /\(([a-zA-Z\u00C0-\u017F\d:\.,;\-\/<>\[\]%_@+"'= ]+)\)/g, r = [], o = /f$/, a = /\.(\d)/, n = ((y = e == null ? void 0 : e.options) == null ? void 0 : y.lang) || Xa.lang, l = (e == null ? void 0 : e.time) || Ga, c = (e == null ? void 0 : e.numberFormatter) || $a, d = (m = "") => {
          let v;
          return m === "true" || m !== "false" && ((v = Number(m)).toString() === m ? v : qa(m) ? m.slice(1, -1) : md(m, t));
        }, u, p, g = 0, x;
        for (; (u = i.exec(h)) !== null; ) {
        ...
        return r.forEach((m) => {
          ...
          if (P) {
            ...
            s.lastIndex = 0, s.test(m.find) && bd(v) && (v = `"${v}"`);
          }
          h = h.replace(m.find, vd(v, ""));
        }), x ? Fs(h, t, e) : h;
      }
      function $a(h, t, e, i) {
        var x;
        t *= 1;
        let s, r, [o, a] = (h = +h || 0).toString().split("e").map(Number), n = ((x = this == null ? void 0 : this.options) == null ? void 0 : x.lang) || Xa.lang, l = (h.toString().split(".")[1] || "").split("e")[0].length, c = t, d = {};
        e ?? (e = n.decimalPoint), i ?? (i = n.thousandsSep), t === -1 ? t = Math.min(l, 20) : Ya(t) ? t && a < 0 && ((r = t + a) >= 0 ? (o = +o.toExponential(r).split("e")[0], t = r) : (o = Math.floor(o), h = t < 20 ? +(o * Math.pow(10, a)).toFixed(t) : 0, a = 0)) : t = 2, a && (t ?? (t = 2), h = o), Ya(t) && t >= 0 && (d.minimumFractionDigits = t, d.maximumFractionDigits = t), i === "" && (d.useGrouping = !1);
        let u = i || e, p = u ? "en" : (this == null ? void 0 : this.locale) || n.locale || fd, g = JSON.stringify(d) + p;
        return s = (Ua[g] ?? (Ua[g] = new Intl.NumberFormat(p, d))).format(h), u && (s = s.replace(/([,\.])/g, "_$1").replace(/_\,/g, i ?? ",").replace("_.", e ?? ".")), (t || +s != 0) && (!(a < 0) || c) || (s = "0"), a && +s != 0 && (s += "e" + (a < 0 ? "" : "+") + a), s;
      }
      let oe = { dateFormat: function(h, t, e) {
        return Ga.dateFormat(h, t, e);
      }, format: Fs, helpers: zs, numberFormat: $a };
      (function(h) {
        let t;
      ...
      let os = F, { clamp: kd, pick: Sd, pushUnique: Md, stableSort: Kr } = V;
      (z || (z = {})).distribute = function h(t, e, i) {
        ...
        if (m > r) {
          for (Kr(t, (w, T) => (T.rank || 0) - (w.rank || 0)), p = (v = t[0].rank === t[t.length - 1].rank) ? n / 2 : -1, u = v ? p : n - 1; p && m > r; ) x = t[d = Math.floor(u)], Md(l, d) && (m -= x.size), u += p, v && u >= t.length && (p /= 2, u = p);
          l.sort((w, T) => T - w).forEach((w) => c.apply(a, t.splice(w, 1)));
        }
        for (Kr(t, o), t = t.map((w) => ({ size: w.size, targets: [w.target], align: Sd(w.align, 0.5) })); g; ) {
          for (d = t.length; d--; ) x = t[d], y = (Math.min.apply(0, x.targets) + Math.max.apply(0, x.targets)) / 2, x.pos = kd(y - x.size * x.align, 0, e - x.size);
      ...
      let Ws = z, { animate: Cd, animObject: Td, stop: Va } = Xt, { deg2rad: Ka, doc: Oi, svg: Ad, SVG_NS: Hs, win: Od, isFirefox: Pd } = E, { addEvent: Ld, attr: Qr, createElement: Ed, crisp: js, css: Qa, defined: ve, erase: Id, extend: as, fireEvent: _r, getAlignFactor: Zr, isArray: _a, isFunction: Za, isNumber: Rd, isObject: Dd, isString: Ja, merge: Jr, objectEach: Pi, pick: Le, pInt: Xs, pushUnique: Bd, replaceNested: Nd, syncTimeout: zd, uniqueKey: tn } = V;
      class Wt {
        _defaultGetter(t) {
        ...
        align(t, e, i, s = !0) {
          ...
          let n = !i || Ja(i) ? i || "renderer" : void 0;
          n && (a && Bd(o, this), i = void 0);
          let l = Le(i, r[n], r), c = (l.x || 0) + (t.x || 0) + ((l.width || 0) - (t.width || 0)) * Zr(t.align), d = (l.y || 0) + (t.y || 0) + ((l.height || 0) - (t.height || 0)) * Zr(t.verticalAlign), u = { "text-align": t == null ? void 0 : t.align };
        ...
        animate(t, e, i) {
          let s = Td(Le(e, this.renderer.globalAnimation, !0)), r = s.defer;
          return Oi.hidden && (s.duration = 0), s.duration !== 0 ? (i && (s.complete = i), zd(() => {
            this.element && Cd(this, t, s);
        ...
        applyTextOutline(t) {
          ...
          if (r && r !== "none" && E.svg) {
            ...
            Qr(o, { class: "highcharts-text-outline", fill: s, stroke: s, "stroke-width": r, "stroke-linejoin": "round" });
            ...
            l.textContent = "​", Qr(l, { x: Number(e.getAttribute("x")), dy: -n }), o.appendChild(l), a.insertBefore(o, a.firstChild);
          }
        }
        attr(t, e, i, s) {
          ...
          return typeof t == "string" && e !== void 0 && (a = t, (t = {})[a] = e), typeof t == "string" ? l = (this[t + "Getter"] || this._defaultGetter).call(this, t, r) : (Pi(t, function(d, u) {
            c = !1, s || Va(this, u), this.symbolName && o.indexOf(u) !== -1 && (n || (this.symbolAttr(t), n = !0), c = !0), this.rotation && (u === "x" || u === "y") && (this.doTransform = !0), c || (this[u + "Setter"] || this._defaultSetter).call(this, d, u, r);
          }, this), this.afterSetters()), i && i.call(this), l;
        }
        clip(t) {
          if (t && !t.clipPath) {
            let e = tn() + "-", i = this.renderer.createElement("clipPath").attr({ id: e }).add(this.renderer.defs);
        ...
        complexColor(t, e, i) {
          ...
          _r(this.renderer, "complexColor", { args: arguments }, function() {
            if (t.radialGradient ? o = "radialGradient" : t.linearGradient && (o = "linearGradient"), o) {
              if (a = t[o], l = s.gradients, c = t.stops, p = i.radialReference, _a(a) && (t[o] = a = { x1: a[0], y1: a[1], x2: a[2], y2: a[3], gradientUnits: "userSpaceOnUse" }), o === "radialGradient" && p && !ve(a.gradientUnits) && (n = a, a = Jr(a, s.getRadialAttr(p, n), { gradientUnits: "userSpaceOnUse" })), Pi(a, function(m, v) {
                v !== "id" && x.push(v, m);
              }), Pi(c, function(m) {
                x.push(m);
        ...
        css(t) {
          ...
          if (e && Pi(t, function(a, n) {
            ...
            e && (t = as(e, i)), t.width === null || t.width === "auto" ? delete this.textWidth : s.nodeName.toLowerCase() === "text" && t.width && (r = this.textWidth = Xs(t.width)), as(this.styles, t), r && !Ad && this.renderer.forExport && delete t.width;
            let a = Pd && t.fontSize || null;
            a && (Rd(a) || /^\d+$/.test(a)) && (t.fontSize += "px");
            let n = Jr(t);
            s.namespaceURI === this.SVG_NS && (["textOutline", "textOverflow", "whiteSpace", "width"].forEach((l) => n && delete n[l]), n.color && (n.fill = n.color, delete n.color)), Qa(s, n);
          }
        ...
        destroy() {
          ...
          if (e.onclick = e.onmouseout = e.onmouseover = e.onmousemove = e.point = null, Va(t), t.clipPath && s) {
            let n = t.clipPath;
          ...
          t.alignOptions && Id(i.alignedObjects, t), Pi(t, (n, l) => {
            var c, d, u;
        ...
        dSetter(t, e, i) {
          _a(t) && (typeof t[0] == "string" && (t = this.renderer.pathToSegments(t)), this.pathArray = t, t = t.reduce((s, r, o) => r != null && r.join ? (o ? s + " " : "") + r.join(" ") : (r || "").toString(), "")), /(NaN| {2}|^$)/.test(t) && (t = "M 0 0"), this[e] !== t && (i.setAttribute(e, t), this[e] = t);
        }
        fillSetter(t, e, i) {
        ...
        getBBox(t, e) {
          ...
          if (ve(d) && ((o = d.toString()).indexOf("<") === -1 && (o = o.replace(/\d/g, "0")), o += ["", l.rootFontSize, y, x, this.textWidth, a, c.lineClamp, c.textOverflow, c.fontWeight].join(",")), o && !t && (i = u[o]), !i || i.polygon) {
            if (g || l.forExport) {
              try {
                r = this.fakeTS && function(v) {
                  ...
                  w && Qa(w, { display: v });
                }, Za(r) && r("none"), i = n.getBBox ? as({}, n.getBBox()) : { width: n.offsetWidth, height: n.offsetHeight, x: 0, y: 0 }, Za(r) && r("");
              } catch {
              }
            ...
            let m = { bBox: i };
            _r(this, "afterGetBBox", m), i = m.bBox;
          }
          if (o && (d === "" || i.height > 0)) {
        ...
        constructor(t, e) {
          this.onEvents = {}, this.opacity = 1, this.SVG_NS = Hs, this.element = e === "span" || e === "body" ? Ed(e) : Oi.createElementNS(this.SVG_NS, e), this.renderer = t, this.styles = {}, _r(this, "afterInit");
        }
        on(t, e) {
          let { onEvents: i } = this;
          return i[t] && i[t](), i[t] = Ld(this.element, t, e), this;
        }
        opacitySetter(t, e, i) {
        ...
        removeClass(t) {
          return this.attr("class", ("" + this.attr("class")).replace(Ja(t) ? RegExp(`(^| )${t}( |$)`) : t, " ").replace(/ +/g, " ").trim());
        }
        removeTextOutline() {
        ...
        shadow(t) {
          var r;
          let { renderer: e } = this, i = Jr(((r = this.parentGroup) == null ? void 0 : r.rotation) === 90 ? { offsetX: -1, offsetY: -1 } : {}, Dd(t) ? t : {}), s = e.shadowDefinition(i);
        ...
        strokeWidth() {
          ...
          return /px$/.test(t) ? e = Xs(t) : t !== "" && (Qr(i = Oi.createElementNS(Hs, "rect"), { width: t, "stroke-width": 0 }), this.element.parentNode.appendChild(i), e = i.getBBox().width, i.parentNode.removeChild(i)), e;
        }
        symbolAttr(t) {
          let e = this;
        ...
        titleSetter(t) {
          ...
          e.insertBefore ? e.insertBefore(i, e.firstChild) : e.appendChild(i), i.textContent = Nd(Le(t, ""), [/<[^>]*>/g, ""]).replace(/&lt;/g, "<").replace(/&gt;/g, ">");
        }
        toFront() {
          let t = this.element;
      ...
      let we = Wt, { defined: en, extend: Fd, getAlignFactor: sn, isNumber: ns, merge: Wd, pick: Gs, removeEvent: rn } = V;
      class ai extends we {
        ...
        destroy() {
          rn(this.element, "mouseenter"), rn(this.element, "mouseleave"), this.text && this.text.destroy(), this.box && (this.box = this.box.destroy()), we.prototype.destroy.call(this);
        }
        fillSetter(t, e) {
        ...
        onAdd() {
          this.text.add(this), this.attr({ text: Gs(this.textStr, ""), x: this.x || 0, y: this.y || 0 }), this.box && en(this.anchorX) && this.attr({ anchorX: this.anchorX, anchorY: this.anchorY });
        }
        paddingSetter(t, e) {
        ...
        updateBoxSize() {
          let t, e = this.text, i = {}, s = this.padding, r = this.bBox = (!ns(this.widthSetting) || !ns(this.heightSetting) || this.textAlign) && en(e.textStr) ? e.getBBox(void 0, 0) : ai.emptyBBox;
          ...
          if (this.baselineOffset = s + Math.min((this.text.firstLineMetrics || o).b, r.height || 1 / 0), this.heightSetting && (this.baselineOffset += (this.heightSetting - o.h) / 2), this.needsBox && !e.textPath) {
            ...
            i.x = t = this.getCrispAdjust(), i.y = (this.baseline ? -this.baselineOffset : 0) + t, i.width = Math.round(this.width), i.height = Math.round(this.height), this.box.attr(Fd(i, this.deferredAttr)), this.deferredAttr = {};
          }
        }
        updateTextPadding() {
          ...
          if (!t.textPath) {
            this.updateBoxSize();
            let i = this.baseline ? 0 : this.baselineOffset, s = (this.paddingLeft ?? this.padding) + sn(e) * (this.widthSetting ?? this.bBox.width);
      ...
      let { defined: on, isNumber: Hd, pick: ls } = V;
      function an(h, t, e, i, s) {
        ...
        if (s) {
          ...
          w.params = { start: o, end: a, cx: h, cy: t }, r.push(["M", h + n * g, t + l * x], w), on(u) && ((w = ["A", u, u, 0, v, on(s.clockwise) ? 1 - s.clockwise : 0, h + u * g, t + u * x]).params = { start: a, end: o, cx: h, cy: t }, r.push(p ? ["M", h + u * y, t + u * m] : ["L", h + u * y, t + u * m], w)), p || r.push(["Z"]);
        }
        return r;
      }
      function nn(h, t, e, i, s) {
        return s != null && s.r ? to(h, t, e, i, s) : [["M", h, t], ["L", h + e, t], ["L", h + e, t + i], ["L", h, t + i], ["Z"]];
      }
      function to(h, t, e, i, s) {
      ...
      let ln = { arc: an, callout: function(h, t, e, i, s) {
        let r = Math.min((s == null ? void 0 : s.r) || 0, e, i), o = r + 6, a = s == null ? void 0 : s.anchorX, n = (s == null ? void 0 : s.anchorY) || 0, l = to(h, t, e, i, { r });
        if (!Hd(a) || a < e && a > 0 && n < i && n > 0) return l;
        if (h + a > e - o)
        ...
        return an(h + e / 2, t + i / 2, e / 2, i / 2, { start: 0.5 * Math.PI, end: 2.5 * Math.PI, open: !1 });
      }, diamond: function(h, t, e, i) {
        return [["M", h + e / 2, t], ["L", h + e, t + i / 2], ["L", h + e / 2, t + i], ["L", h, t + i / 2], ["Z"]];
      }, rect: nn, roundedRect: to, square: nn, triangle: function(h, t, e, i) {
        return [["M", h + e / 2, t], ["L", h + e, t + i], ["L", h, t + i], ["Z"]];
      }, "triangle-down": function(h, t, e, i) {
        return [["M", h, t], ["L", h + e, t], ["L", h + e / 2, t + i], ["Z"]];
      } }, { doc: eo, SVG_NS: jd, win: hn } = E, { attr: io, extend: Xd, fireEvent: Gd, isString: Yd, objectEach: Ud, pick: qd } = V, so = (h, t) => h.substring(0, t) + "…", $d = class {
        constructor(h) {
          let t = h.styles;
        ...
        buildSVG() {
          let h = this.svgElement, t = h.element, e = h.renderer, i = qd(h.textStr, "").toString(), s = i.indexOf("<") !== -1, r = t.childNodes, o = !h.added && e.box, a = [i, this.ellipsis, this.noWrap, this.textLineHeight, this.textOutline, h.getStyle("font-size"), h.styles.lineClamp, this.width].join(",");
          if (a !== h.textCache) {
            ...
            } else t.appendChild(eo.createTextNode(this.unescapeEntities(i)));
            Yd(this.textOutline) && h.applyTextOutline && h.applyTextOutline(this.textOutline);
          }
        }
        modifyDOM() {
          let h, t = this.svgElement, e = io(t.element, "x");
          ...
          [].forEach.call(t.element.querySelectorAll("tspan.highcharts-br"), (o, a) => {
            o.nextSibling && o.previousSibling && (a === 0 && o.previousSibling.nodeType === 1 && (t.firstLineMetrics = t.renderer.fontMetrics(o.previousSibling)), io(o, { dy: this.getLineHeight(o.nextSibling), x: e }));
          });
          let i = this.width || 0;
          if (!i) return;
          let s = (o, a) => {
            ...
            if (c) {
              ...
              for (; l.length; ) if (l.length && !this.noWrap && p > 0 && (y.push(o.textContent || ""), o.textContent = l.join(" ").replace(/- /g, "-")), this.truncate(o, void 0, l, p === 0 && g || 0, i, u, (v, w) => l.slice(0, w).join(" ").replace(/- /g, "-")), g = t.actualWidth, p++, this.lineClamp && p >= this.lineClamp) {
                l.length && (this.truncate(o, o.textContent || "", void 0, 0, i, u, so), o.textContent = ((x = o.textContent) == null ? void 0 : x.replace("…", "")) + "…");
                break;
              }
              m.forEach((v) => {
                a.insertBefore(v, o);
              }), y.forEach((v) => {
                a.insertBefore(eo.createTextNode(v), o);
                let w = eo.createElementNS(jd, "tspan");
                w.textContent = "​", io(w, { dy: d, x: e }), a.insertBefore(w, o);
              });
            } else this.ellipsis && n && this.truncate(o, n, void 0, 0, i, u, so);
          }, r = (o) => {
            [].slice.call(o.childNodes).forEach((a) => {
              a.nodeType === hn.Node.TEXT_NODE ? s(a, o) : (a.className.baseVal.indexOf("highcharts-br") !== -1 && (t.actualWidth = 0), r(a));
            });
          };
          r(t.element);
        }
        getLineHeight(h) {
          let t = h.nodeType === hn.Node.TEXT_NODE ? h.parentElement : h;
        ...
        modifyTree(h) {
          let t = (e, i) => {
            ...
            a !== "#text" && a !== "a" && (e.tagName = "tspan"), Xd(e, { attributes: s, style: o }), r && r.filter((l) => l.tagName !== "#text").forEach(t);
          };
          h.forEach(t), Gd(this.svgElement, "afterModifyTree", { nodes: h });
        }
      ...
      class $s {
        ...
        destroy() {
          let t = this.defs;
          return this.box = null, this.boxWrapper = this.boxWrapper.destroy(), tc(this.gradients || {}), this.gradients = null, this.defs = t.destroy(), this.unSubPixelFix && this.unSubPixelFix(), this.alignedObjects = null, null;
        }
        createElement(t) {
        ...
        shadowDefinition(t) {
          let e = [`highcharts-drop-shadow-${this.chartIndex}`, ...Object.keys(t).map((s) => `${s}-${t[s]}`)].join("-").toLowerCase().replace(/[^a-z\d\-]/g, ""), i = ao({ color: "#000000", offsetX: 1, offsetY: 1, opacity: 0.15, width: 5 }, t);
        ...
        button(t, e, i, s, r = {}, o, a, n, l, c) {
          ...
          r = ao(Vd.global.buttonTheme, r), u && (delete r.fill, delete r.stroke, delete r["stroke-width"]);
          ...
          return u || ["hover", "select", "disabled"].forEach((w, T) => {
            m.push(ao(m[0], Tt.filterUserAttributes(p[T + 5] || x[w] || {}))), v.push(m[T + 1].style), delete m[T + 1].style;
          }), Ys(d.element, un ? "mouseover" : "mouseenter", function() {
            g !== 3 && d.setState(1);
          }), Ys(d.element, un ? "mouseout" : "mouseleave", function() {
            g !== 3 && d.setState(g);
          }), d.setState = (w = 0) => {
        ...
        crispLine(t, e) {
          let [i, s] = t;
          return ni(i[1]) && i[1] === s[1] && (i[1] = s[1] = pn(i[1], e)), ni(i[2]) && i[2] === s[2] && (i[2] = s[2] = pn(i[2], e)), t;
        }
        path(t) {
          let e = this.styledMode ? {} : { fill: "none" };
          return ec(t) ? e.d = t : hs(t) && li(e, t), this.createElement("path").attr(e);
        }
        circle(t, e, i) {
        ...
        setSize(t, e, i) {
          ...
          }, duration: no(i, !0) ? void 0 : 0 }), this.alignElements();
        }
        g(t) {
        ...
        symbol(t, e, i, s, r, o) {
          ...
          if (x) typeof e == "number" && (n = x.call(this.symbols, e || 0, i || 0, s || 0, r || 0, o)), a = this.path(n), d.styledMode || a.attr("fill", "none"), li(a, { symbolName: g || void 0, x: e, y: i, width: s, height: r }), o && li(a, o);
            ...
            v.imgwidth = no(o == null ? void 0 : o.width, (y = ro[l]) == null ? void 0 : y.width), v.imgheight = no(o == null ? void 0 : o.height, (m = ro[l]) == null ? void 0 : m.height), c = (w) => w.attr({ width: w.width, height: w.height }), ["width", "height"].forEach((w) => {
            ...
            }), ni(e) && v.attr({ x: e, y: i }), v.isImg = !0, v.symbolUrl = t, ni(v.imgwidth) && ni(v.imgheight) ? c(v) : (v.attr({ width: 0, height: 0 }), Jd("img", { onload: function() {
              let w = Kd[d.chartIndex];
              this.width === 0 && (qs(this, { position: "absolute", top: "-999em" }), Li.body.appendChild(this)), ro[l] = { width: this.width, height: this.height }, v.imgwidth = this.width, v.imgheight = this.height, v.element && c(v), this.parentNode && this.parentNode.removeChild(this), d.imgCount--, d.imgCount || !w || w.hasLoaded || w.onload();
            }, src: l }), this.imgCount++);
          }
          return a;
        }
        ...
        fontMetrics(t) {
          let e = sc(we.prototype.getStyle.call(t, "font-size") || 0), i = e < 24 ? e + 3 : Math.round(1.2 * e), s = Math.round(0.8 * i);
          return { h: i, b: s, f: e };
        }
        rotCorr(t, e, i) {
          let s = t;
          return e && i && (s = Math.max(s * Math.cos(e * dn), 4)), { x: -t / 3 * Math.sin(e * dn), y: s };
        }
        pathToSegments(t) {
          let e = [], i = [], s = { A: 8, C: 7, H: 2, L: 3, M: 3, Q: 5, S: 5, T: 3, V: 2 };
          for (let r = 0; r < t.length; r++) ic(i[0]) && Ei(t[r]) && i.length === s[i[0].toUpperCase()] && t.splice(r, 0, i[0].replace("M", "L").replace("m", "l")), typeof t[r] == "string" && (i.length && e.push(i.slice(0)), i.length = 0), i.push(t[r]);
      ...
      li($s.prototype, { Element: we, SVG_NS: Zd, escapes: { "&": "&amp;", "<": "&lt;", ">": "&gt;", "'": "&#39;", '"': "&quot;" }, symbols: ln, draw: _d }), os.registerRendererType("svg", $s, !0);
      let { composed: ac, isFirefox: nc } = E, { attr: lc, css: Fe, createElement: hc, defined: fn, extend: dc, getAlignFactor: cc, isNumber: Vs, pInt: uc, pushUnique: pc } = V;
      function gn(h, t, e) {
        var s;
      ...
      let fc = (h, t) => {
        var e;
        if (!h.div) {
          let i = lc(h.element, "class"), s = h.css, r = hc("div", i ? { className: i } : void 0, { position: "absolute", left: `${h.translateX || 0}px`, top: `${h.translateY || 0}px`, ...h.styles, display: h.display, opacity: h.opacity, visibility: h.visibility }, ((e = h.parentGroup) == null ? void 0 : e.div) || t);
          h.classSetter = (o, a, n) => {
          ...
          }, h.opacitySetter = h.visibilitySetter = gn, h.css = (o) => (s.call(h, o), o.cursor && (r.style.cursor = o.cursor), o.pointerEvents && (r.style.pointerEvents = o.pointerEvents), h), h.on = function() {
      ...
      class Ii extends we {
        static compose(t) {
          pc(ac, this.compose) && (t.prototype.html = function(e, i, s) {
        ...
        css(t) {
          ...
          return s && (delete t.width, this.textWidth = uc(r) || void 0, e = !0), (t == null ? void 0 : t.textOverflow) === "ellipsis" && (t.overflow = "hidden", t.whiteSpace = "nowrap"), t != null && t.lineClamp && (t.display = "-webkit-box", t.WebkitLineClamp = t.lineClamp, t.WebkitBoxOrient = "vertical", t.overflow = "hidden"), Vs(Number(t == null ? void 0 : t.fontSize)) && (t.fontSize += "px"), dc(this.styles, t), Fe(i, t), e && this.updateTransform(), this;
        }
        htmlGetBBox() {
          let { element: t } = this;
        ...
        updateTransform() {
          ...
          if (e || Fe(t, { marginLeft: `${g}px`, marginTop: `${x}px` }), t.tagName === "SPAN") {
            ...
            e && (Fe(t, { display: "inline-block", verticalAlign: "top" }), e.attr({ width: s.width, height: s.height })), T !== this.cTT && (w = s.fontMetrics(t).b, fn(r) && !e && (r !== (this.oldRotation || 0) || u !== this.oldAlign) && Fe(t, { transform: `rotate(${r}deg)`, transformOrigin: `${S}% ${S}px` }), this.getSpanCorrection(!fn(r) && !this.textWidth && this.textPxLength || t.offsetWidth, w, cc(u)));
            let { xCorr: M = 0, yCorr: P = 0 } = this, A = { left: `${y + M}px`, top: `${m + P}px`, textAlign: u, transformOrigin: `${(o ?? y) - M - y - S}px ${(a ?? m) - P - m - S}px` };
            (n || l) && (A.transform = `scale(${n ?? 1},${l ?? 1})`), e ? (super.updateTransform(), Vs(y) && Vs(m) ? (e.attr({ x: y + M, y: m + P, width: t.offsetWidth + 3, height: t.offsetHeight, "transform-origin": t.getAttribute("transform-origin") || "0 0" }), Fe(t, { display: c, textAlign: u })) : nc && e.attr({ width: 0, height: 0 })) : Fe(t, A), this.cTT = T, this.oldRotation = r, this.oldAlign = u;
          }
        }
        add(t) {
          ...
          if (e) e.add(t), super.add(i.createElement("body").attr({ xmlns: "http://www.w3.org/1999/xhtml" }).css({ background: "transparent", margin: "0 3px 0 0" }).add(e));
            ...
            if (this.parentGroup = t, t && !(o = t.div)) {
              ...
              for (let n of r.reverse()) o = fc(n, s);
            }
      ...
      let hi = Ii.prototype;
      hi.visibilitySetter = hi.opacitySetter = gn, hi.ySetter = hi.rotationSetter = hi.rotationOriginXSetter = hi.rotationOriginYSetter = hi.xSetter, function(h) {
      ...
      let gc = W, { addEvent: mc, isFunction: yc, objectEach: xc, removeEvent: bc } = V;
      (Y || (Y = {})).registerEventOptions = function(h, t) {
        h.eventOptions = h.eventOptions || {}, xc(t.events, function(e, i) {
          h.eventOptions[i] !== e && (h.eventOptions[i] && (bc(h, i, h.eventOptions[i]), delete h.eventOptions[i]), yc(e) && (h.eventOptions[i] = e, mc(h, i, e, { order: 0 })));
        });
      };
      let Ks = Y, { deg2rad: lo } = E, { clamp: vc, correctFloat: Qs, defined: ho, destroyObjectProperties: wc, extend: mn, fireEvent: ds, getAlignFactor: kc, isNumber: _s, merge: Sc, objectEach: Mc, pick: ke } = V, Ri = class {
        ...
        addLabel() {
          ...
          M ? h.shortenLabel = function() {
            for (m = 0; m < M.length; m++) if (mn(w, { dateTimeLabelFormat: M[m] }), g.attr({ text: T.call(w, w) }), g.getBBox().width < t.getSlotWidth(h) - 2 * (n.padding || 0)) return;
            g.attr({ text: "" });
          } : h.shortenLabel = void 0, u && t._addedPlotLB && h.moveLabel(S, n), ho(g) || h.movedLabel ? g && g.textStr !== S && !u && (!g.textWidth || n.style.width || g.styles.width || g.css({ width: null }), g.attr({ text: S }), g.textPxLength = g.getBBox().width) : (h.label = g = h.createLabel(S, n), h.rotation = 0);
        }
        createLabel(h, t, e) {
          let i = this.axis, { renderer: s, styledMode: r } = i.chart, o = t.style.whiteSpace, a = ho(h) && t.enabled ? s.text(h, e == null ? void 0 : e.x, e == null ? void 0 : e.y, t.useHTML).add(i.labelGroup) : void 0;
          return a && (r || a.css(Sc(t.style)), a.textPxLength = a.getBBox().width, !r && o && a.css({ whiteSpace: o })), a;
        }
        destroy() {
          wc(this, this.axis);
        }
        getPosition(h, t, e, i) {
          ...
          return a.y = vc(a.y, -1e9, 1e9), ds(this, "afterGetPosition", { pos: a }), a;
        }
        getLabelPosition(h, t, e, i, s, r, o, a) {
          ...
          return n = c.side === 0 ? e.rotation ? -y : -e.getBBox().height : c.side === 2 ? g.y + y : Math.cos(e.rotation * lo) * (g.y - e.getBBox(!1, 0).height / 2), ho(s.y) && (n = c.side === 0 && c.horiz ? s.y + n : s.y), h = h + ke(s.x, [0, 1, 0, -1][c.side] * y) + x + g.x - (r && i ? r * d * (u ? -1 : 1) : 0), t = t + n - (r && !i ? r * d * (u ? 1 : -1) : 0), p && (l = o / (a || 1) % p, c.opposite && (l = p - l - 1), t += l * (c.labelOffset / p)), m.x = h, m.y = Math.round(t), ds(this, "afterGetLabelPosition", { pos: m, tickmarkOffset: r, index: o }), m;
        }
        getLabelSize() {
        ...
        handleOverflow(h) {
          var y;
          let t = this.axis, e = t.options.labels, i = h.x, s = t.chart.chartWidth, r = t.chart.spacing, o = ke(t.labelLeft, Math.min(t.pos, r[3])), a = ke(t.labelRight, Math.max(t.isRadial ? 0 : t.pos + t.len, s - r[1])), n = this.label, l = this.rotation, c = kc(t.labelAlign || n.attr("align")), d = n.getBBox().width, u = t.getSlotWidth(this), p = u, g = 1, x;
          l || e.overflow !== "justify" ? l < 0 && i - c * d < o ? x = Math.round(i / Math.cos(l * lo) - o) : l > 0 && i + c * d > a && (x = Math.round((s - i) / Math.cos(l * lo))) : (i - c * d < o ? p = h.x + p * (1 - c) - o : i + (1 - c) * d > a && (p = a - h.x + p * c, g = -1), (p = Math.min(u, p)) < u && t.labelAlign === "center" && (h.x += g * (u - p - c * (u - Math.min(d, p)))), (d > p || t.autoRotation && ((y = n == null ? void 0 : n.styles) != null && y.width)) && (x = p)), x && n && (this.shortenLabel ? this.shortenLabel() : n.css(mn({}, { width: Math.floor(x) + "px", lineClamp: +!t.isRadial })));
        }
        moveLabel(h, t) {
          let e = this, i = e.label, s = e.axis, r = !1, o;
          i && i.textStr === h ? (e.movedLabel = i, r = !0, delete e.label) : Mc(s.ticks, function(a) {
      ...
      }, { animObject: Cc } = Xt, { xAxis: yn, yAxis: Tc } = gc, { defaultOptions: co } = re, { registerEventOptions: Ac } = Ks, { deg2rad: Oc } = E, { arrayMax: xn, arrayMin: Pc, clamp: uo, correctFloat: ee, defined: St, destroyObjectProperties: Lc, erase: bn, error: po, extend: Zs, fireEvent: Ot, getClosestDistance: vn, insertItem: Ec, isArray: wn, isNumber: Z, isString: kn, merge: Js, normalizeTickInterval: Ic, objectEach: tr, pick: lt, relativeLength: er, removeEvent: Rc, splat: Dc, syncTimeout: Bc } = V, Sn = (h, t) => Ic(t, void 0, void 0, lt(h.options.allowDecimals, t < 0.5 || h.tickAmount !== void 0), !!h.tickAmount);
      Zs(co, { xAxis: yn, yAxis: Js(yn, Tc) });
      class Di {
        constructor(t, e, i) {
          this.init(t, e, i);
        }
        init(t, e, i = this.coll) {
          ...
          this.type ?? (this.type = o.type || "linear"), this.uniqueNames ?? (this.uniqueNames = o.uniqueNames ?? !0), Ot(this, "afterSetType"), this.userOptions = e, this.minPixelPadding = 0, this.reversed = lt(o.reversed, this.reversed), this.visible = o.visible, this.zoomEnabled = o.zoomEnabled, this.hasNames = this.type === "category" || o.categories === !0, this.categories = wn(o.categories) && o.categories || (this.hasNames ? [] : void 0), this.names || (this.names = [], this.names.keys = {}), this.plotLinesAndBandsGroups = {}, this.positiveValuesOnly = !!this.logarithmic, this.isLinked = St(o.linkedTo), this.ticks = {}, this.labelEdge = [], this.minorTicks = {}, this.plotLinesAndBands = [], this.alternateBands = {}, this.len ?? (this.len = 0), this.minRange = this.userMinRange = o.minRange || o.maxZoom, this.range = o.range, this.offset = o.offset || 0, this.max = void 0, this.min = void 0;
          let n = lt(o.crosshair, Dc(t.options.tooltip.crosshairs)[+!s]);
          this.crosshair = n === !0 ? {} : n, t.axes.indexOf(this) === -1 && (s ? t.axes.splice(t.xAxis.length, 0, this) : t.axes.push(this), Ec(this, t[this.coll])), t.orderItems(this.coll), this.series = this.series || [], t.inverted && !this.isZAxis && s && !St(this.reversed) && (this.reversed = !0), this.labelRotation = Z(a.rotation) ? a.rotation : void 0, Ac(this, o), Ot(this, "afterInit");
        }
        setOptions(t) {
          let e = this.horiz ? { labels: { autoRotation: [-45], padding: 3 }, margin: 15 } : { labels: { padding: 1 }, title: { rotation: 90 * this.side } };
          this.options = Js(e, this.coll === "yAxis" ? { title: { text: this.chart.options.lang.yAxisTitle } } : {}, co[this.coll], t), Ot(this, "afterSetOptions", { userOptions: t });
        }
        defaultLabelFormatter() {
          let t = this.axis, { numberFormatter: e } = this.chart, i = Z(this.value) ? this.value : NaN, s = t.chart.time, r = t.categories, o = this.dateTimeLabelFormat, a = co.lang, n = a.numericSymbols, l = a.numericSymbolMagnitude || 1e3, c = t.logarithmic ? Math.abs(i) : t.tickInterval, d = n == null ? void 0 : n.length, u, p;
          if (r) p = `${this.value}`;
        ...
        getPlotLinePath(t) {
          ...
          function w(S, M, P) {
            return p !== "pass" && (S < M || S > P) && (p ? S = uo(S, M, P) : v = !0), S;
          }
          ...
          return Ot(this, "getPlotLinePath", T, function(S) {
            g = y = (u = uo(u = lt(u, e.translate(a, void 0, void 0, o)), -1e9, 1e9)) + d, x = m = l - u - d, Z(u) ? e.horiz ? (x = r, m = l - e.bottom + (e.options.isInternal ? 0 : i.scrollablePixelsY || 0), g = y = w(g, s, s + e.width)) : (g = s, y = c - e.right + (i.scrollablePixelsX || 0), x = m = w(x, r, r + e.height)) : (v = !0, p = !1), S.path = v && !p ? void 0 : i.renderer.crispLine([["M", g, x], ["L", y, m]], n || 1);
          }), T.path;
        }
        ...
        adjustForMinRange() {
          ...
          this.isXAxis && o === void 0 && !e && (o = St(t.min) || St(t.max) || St(t.floor) || St(t.ceiling) ? null : Math.min(5 * (vn(this.series.map((d) => {
            let u = d.getColumn("x");
            return d.xIncrement ? u.slice(0, 2) : u;
          })) || 0), this.dataMax - this.dataMin)), Z(s) && Z(r) && Z(o) && s - r < o && (n = this.dataMax - this.dataMin >= o, a = (o - s + r) / 2, l = [r - a, i.parse(t.min) ?? r - a], n && (l[2] = e ? e.log2lin(this.dataMin) : this.dataMin), c = [(r = xn(l)) + o, i.parse(t.max) ?? r + o], n && (c[2] = e ? e.log2lin(this.dataMax) : this.dataMax), (s = Pc(c)) - r < o && (l[0] = s - o, l[1] = i.parse(t.min) ?? s - o, r = xn(l))), this.minRange = o, this.min = r, this.max = s;
        }
        getClosest() {
          let t, e;
          if (this.categories) e = 1;
            ...
            }), i.length && (i.sort((s, r) => s - r), t = vn([i]));
          }
          return t && e ? Math.min(t, e) : t || e;
        }
        nameToX(t) {
          let e = wn(this.options.categories), i = e ? this.categories : this.names, s = t.options.x, r;
        ...
        setAxisTranslation() {
          ...
          (r || s || o) && (a = t.getClosest(), i ? (n = i.minPointOffset, l = i.pointRangePadding) : t.series.forEach(function(p) {
            ...
            if (o = Math.max(o, g), !t.single || s) {
              ...
              n = Math.max(n, y && kn(x) ? 0 : g / 2), l = Math.max(l, y && x === "on" ? 0 : g);
            }
        ...
        setTickInterval(t) {
          ...
          !L && X && this.tickInterval < X && (this.tickInterval = X), o || n || L || (this.tickInterval = Sn(this, this.tickInterval)), this.tickAmount || (this.tickInterval = this.unsquish()), this.setTickPositions();
        }
        setTickPositions() {
          var c, d;
          ...
          if (this.tickmarkOffset = this.categories && t.tickmarkPlacement === "between" && this.tickInterval === 1 ? 0.5 : 0, this.single = this.min === this.max && St(this.min) && !this.tickAmount && (this.min % 1 == 0 || t.allowDecimals !== !1), e) n = e.slice();
            ...
            if (!((c = this.ordinal) != null && c.positions) && (this.max - this.min) / this.tickInterval > Math.max(2 * this.len, 200)) n = [this.min, this.max], po(19, !1, this.chart);
              ...
              for (; p <= 2 * u && (n = this.getLinearTickPositions(this.tickInterval, this.min, this.max), this.tickAmount && n.length > this.tickAmount); ) this.tickInterval = Sn(this, p *= 1.1);
            }
        ...
        getThresholdAlignment(t) {
          if ((!Z(this.dataMin) || this !== t && this.series.some((e) => e.isDirty || e.isDirtyData)) && this.getSeriesExtremes(), Z(this.threshold)) {
            let e = uo((this.threshold - (this.dataMin || 0)) / ((this.dataMax || 0) - (this.dataMin || 0)), 0, 1);
        ...
        unsquish() {
          ...
          if (i) {
            if (!t.staggerLines && (Z(o) ? p = [o] : r < t.autoRotationLimit && (p = t.autoRotation)), p) {
              let g, x;
              for (let y of p) (y === o || y && y >= -90 && y <= 90) && (x = (g = l(Math.abs(a / Math.sin(Oc * y)))) + Math.abs(y / 360)) < u && (u = x, d = y, c = g);
            }
          } else c = l(0.75 * a);
        ...
        renderUnsquish() {
          ...
          kn(r.rotation) || (c.rotation = r.rotation || 0), i.forEach(function(y) {
            var w;
            let m = s[y];
        ...
        render() {
          let t, e, i = this, s = i.chart, r = i.logarithmic, o = s.renderer, a = i.options, n = i.isLinked, l = i.tickPositions, c = i.axisTitle, d = i.ticks, u = i.minorTicks, p = i.alternateBands, g = a.stackLabels, x = a.alternateGridColor, y = a.crossing, m = i.tickmarkOffset, v = i.axisLine, w = i.showAxis, T = Cc(o.globalAnimation);
        ...
        destroy(t) {
          ...
          if (Ot(this, "destroy", { keepEvents: t }), t || Rc(e), [e.ticks, e.minorTicks, e.alternateBands].forEach(function(r) {
            Lc(r);
          }), i) {
            let r = i.length;
            for (; r--; ) i[r].destroy();
        ...
        remove(t) {
          ...
          bn(e.axes, this), bn(e[i] || [], this), e.orderItems(i), this.destroy(), e.isDirtyBox = !0, lt(t, !0) && e.redraw();
        }
        setTitle(t, e) {
      ...
      let { addEvent: Nc, getMagnitude: zc, normalizeTickInterval: Fc, timeUnits: ir } = V;
      (function(h) {
        function t() {
        ...
        h.compose = function(s) {
          return s.keepProps.includes("dateTime") || (s.keepProps.push("dateTime"), s.prototype.getTimeTicks = t, Nc(s, "afterSetType", e)), s;
        };
        class i {
          constructor(r) {
            this.axis = r;
          ...
          normalizeTimeTickInterval(r, o) {
            ...
            let u = Fc(r / l, c, n[0] === "year" ? Math.max(zc(r / l), 1) : 1);
      ...
      let Wc = rt, { addEvent: Mn, normalizeTickInterval: Hc, pick: jc } = V;
      (function(h) {
        function t() {
        ...
        h.compose = function(s) {
          return s.keepProps.includes("logarithmic") || (s.keepProps.push("logarithmic"), Mn(s, "afterSetType", t), Mn(s, "afterInit", e)), s;
        };
        class i {
          constructor(r) {
            this.axis = r;
          ...
          getLogTickPositions(r, o, a, n) {
            ...
            if (n || (this.minorAutoInterval = void 0), r >= 0.5) r = Math.round(r), u = l.getLinearTickPositions(r, o, a);
              ...
              r = Hc(r = jc(x === "auto" ? null : x, this.minorAutoInterval, (g - p) * y / (m || 1))), u = l.getLinearTickPositions(r, p, g).map(this.log2lin), n || (this.minorAutoInterval = r / 5);
            }
      ...
      let Xc = st, { erase: Gc, extend: Yc, isNumber: Cn } = V;
      (function(h) {
        let t;
        function e(l) {
        ...
        function r(l, c, d) {
          d = d || this.options;
          let u = this.getPlotLinePath({ value: c, force: !0, acrossPanes: d.acrossPanes }), p = [], g = this.horiz, x = !Cn(this.min) || !Cn(this.max) || l < this.min && c < this.min || l > this.max && c > this.max, y = this.getPlotLinePath({ value: l, force: !0, acrossPanes: d.acrossPanes }), m, v = 1, w;
        ...
        function a(l) {
          ...
          if (c) {
            ...
            [d.plotLines || [], u.plotLines || [], d.plotBands || [], u.plotBands || []].forEach(function(g) {
              var x;
              for (p = g.length; p--; ) ((x = g[p]) == null ? void 0 : x.id) === l && Gc(g, g[p]);
            });
          }
        }
        function n(l) {
        ...
        h.compose = function(l, c) {
          let d = c.prototype;
          return d.addPlotBand || (t = l, Yc(d, { addPlotBand: e, addPlotLine: s, addPlotBandOrLine: i, getPlotBandPath: r, removePlotBand: o, removePlotLine: n, removePlotBandOrLine: a })), c;
        };
      })(U || (U = {}));
      let Uc = U, { addEvent: qc, arrayMax: Tn, arrayMin: An, defined: Se, destroyObjectProperties: $c, erase: Vc, fireEvent: Kc, merge: On, objectEach: Qc, pick: _c } = V;
      class sr {
        static compose(t, e) {
          return qc(t, "afterInit", function() {
        ...
        render() {
          ...
          if (!t.chart.styledMode && (S ? (P.stroke = r || "#999999", P["stroke-width"] = _c(e.width, 1), e.dashStyle && (P.dashstyle = e.dashStyle)) : T && (P.fill = r || "#e6e9ff", g && (P.stroke = e.borderColor, P["stroke-width"] = g))), c.zIndex = a, A += "-" + a, (w = t.plotLinesAndBandsGroups[A]) || (t.plotLinesAndBandsGroups[A] = w = n.g("plot-" + A).attr(c).add()), m || (this.svgElem = m = n.path().attr(P).add(w)), Se(p)) v = t.getPlotLinePath({ value: (s == null ? void 0 : s.log2lin(p)) ?? p, lineWidth: m.strokeWidth(), acrossPanes: e.acrossPanes });
          else {
            if (!(Se(u) && Se(d))) return;
            v = t.getPlotBandPath((s == null ? void 0 : s.log2lin(u)) ?? u, (s == null ? void 0 : s.log2lin(d)) ?? d, e);
          }
          return !this.eventsAdded && o && (Qc(o, (L, R) => {
            m == null || m.on(R, (D) => {
              o[R].apply(this, [D]);
            });
          }), this.eventsAdded = !0), (M || !m.d) && (v != null && v.length) ? m.attr({ d: v }) : m && (v ? (m.show(), m.animate({ d: v })) : m.d && (m.hide(), y && (this.label = y = y.destroy()))), x && (Se(x.text) || Se(x.formatter)) && (v != null && v.length) && t.width > 0 && t.height > 0 && !v.isFlat ? (x = On({ align: i && T ? "center" : void 0, x: i ? !T && 4 : 10, verticalAlign: !i && T ? "middle" : void 0, y: i ? T ? 16 : 10 : T ? 6 : -4, rotation: i && !T ? 90 : 0, ...T ? { inside: !0 } : {} }, x), this.renderLabel(x, v, T, a)) : y && y.hide(), this;
        }
        renderLabel(t, e, i, s) {
          var g;
          let r = this.axis, o = r.chart.renderer, a = t.inside, n = this.label;
          n || (this.label = n = o.text(this.getLabelText(t), 0, 0, t.useHTML).attr({ align: t.textAlign || t.align, rotation: t.rotation, class: "highcharts-plot-" + (i ? "band" : "line") + "-label " + (t.className || ""), zIndex: s }), r.chart.styledMode || n.css(On({ fontSize: "0.8em", textOverflow: i && !a ? "" : "ellipsis" }, t.style)), n.add());
          let l = e.xBounds || [e[0][1], e[1][1], i ? e[2][1] : e[0][1]], c = e.yBounds || [e[0][2], e[1][2], i ? e[2][2] : e[0][2]], d = An(l), u = An(c), p = Tn(l) - d;
          n.align(t, !1, { x: d, y: u, width: p, height: Tn(c) - u }), n.alignAttr.y -= o.fontMetrics(n).b, (!n.alignValue || n.alignValue === "left" || Se(a)) && n.css({ width: (((g = t.style) == null ? void 0 : g.width) || (i && a ? p : n.rotation === 90 ? r.height - (n.alignAttr.y - r.top) : (t.clip ? r.width : r.chart.chartWidth) - (n.alignAttr.x - r.left))) + "px" }), n.show(!0);
        }
        getLabelText(t) {
          return Se(t.formatter) ? t.formatter.call(this) : t.text;
        }
        destroy() {
          Vc(this.axis.plotLinesAndBands, this), delete this.axis, $c(this);
        }
      }
      let { animObject: Zc } = Xt, { format: Pn } = oe, { composed: Jc, dateFormats: tu, doc: Ln, isSafari: eu } = E, { distribute: iu } = Ws, { addEvent: su, clamp: Bi, css: En, discardElement: ru, extend: ou, fireEvent: In, getAlignFactor: Rn, isArray: au, isNumber: nu, isObject: lu, isString: fo, merge: hu, pick: Ni, pushUnique: du, splat: go, syncTimeout: cu } = V;
      class mo {
        constructor(t, e, i) {
        ...
        defaultFormatter(t) {
          let e, i = this.points || go(this);
          return (e = (e = [t.headerFooterFormatter(i[0])]).concat(t.bodyFormatter(i))).push(t.headerFooterFormatter(i[0], !0)), e;
        }
        destroy() {
          this.label && (this.label = this.label.destroy()), this.split && (this.cleanSplit(!0), this.tt && (this.tt = this.tt.destroy())), this.renderer && (this.renderer = this.renderer.destroy(), ru(this.container)), V.clearTimeout(this.hideTimer);
        }
        getAnchor(t, e) {
          var l;
          let i, { chart: s, pointer: r } = this, o = s.inverted, a = s.plotTop, n = s.plotLeft;
          if (t = go(t), (l = t[0].series) != null && l.yAxis && !t[0].series.yAxis.options.reversedStacks && (t = t.slice().reverse()), this.followPointer && e) e.chartX === void 0 && (e = r.normalize(e)), i = [e.chartX - n, e.chartY - a];
        ...
        getClassName(t, e, i) {
          ...
          return [s.className, "highcharts-label", i && "highcharts-tooltip-header", e ? "highcharts-tooltip-box" : "highcharts-tooltip", !i && "highcharts-color-" + Ni(t.colorIndex, r.colorIndex), o == null ? void 0 : o.className].filter(fo).join(" ");
        }
        getLabel({ anchorX: t, anchorY: e } = { anchorX: 0, anchorY: 0 }) {
          ...
          if (!this.label) {
            if (this.outside) {
              ...
              this.container = a = E.doc.createElement("div"), a.className = "highcharts-tooltip-container " + (l.renderTo.className.match(/(highcharts[a-zA-Z0-9-]+)\s?/gm) || ""), En(a, { position: "absolute", top: "1px", pointerEvents: "none", zIndex: Math.max(this.options.style.zIndex || 0, ((c == null ? void 0 : c.zIndex) || 0) + 3) }), this.renderer = n = new d(a, 0, 0, c, void 0, void 0, n.styledMode);
            }
        ...
        getPlayingField() {
          let { body: t, documentElement: e } = Ln, { chart: i, distance: s, outside: r } = this;
        ...
        getFixedPosition(t, e, i) {
          ...
          return { x: d.x + (d.width - t) * Rn(n.align) + n.x, y: d.y + (d.height - e) * Rn(n.verticalAlign) + (!a && n.y || 0) };
        }
        hide(t) {
          let e = this;
          V.clearTimeout(this.hideTimer), t = Ni(t, this.options.hideDelay), this.isHidden || (this.hideTimer = cu(function() {
            let i = e.getLabel();
        ...
        move(t, e, i, s) {
          let { followPointer: r, options: o } = this, a = Zc(!r && !this.isHidden && !o.fixed && o.animation), n = r || (this.len || 0) > 1, l = { x: t, y: e };
          n ? l.anchorX = l.anchorY = NaN : (l.anchorX = i, l.anchorY = s), a.step = () => this.drawTracker(), this.getLabel().animate(l, a);
        }
        refresh(t, e) {
          let { chart: i, options: s, pointer: r, shared: o } = this, a = go(t), n = a[0], l = s.format, c = s.formatter || this.defaultFormatter, d = i.styledMode, u = this.allowShared;
          if (!s.enabled || !n.series) return;
          V.clearTimeout(this.hideTimer), this.allowShared = !(!au(t) && t.series && t.series.noSharedTooltip), u = u && !this.allowShared, this.followPointer = !this.split && n.series.tooltipOptions.followPointer;
          ...
          let y = fo(l) ? Pn(l, n, i) : c.call(n, this);
          n.points = void 0;
          let m = n.series;
        ...
        renderSplit(t, e) {
            ...
            if (bt !== !1 && bt !== "") {
              ...
              let { anchorX: le, anchorY: he } = function(Qt) {
                ...
                if (Ve) Nt = Math.max(n + fi, n), Ss = l + a / 2;
                  ...
                  let { xAxis: Hi, yAxis: Ql } = me;
                  Nt = Hi.pos + Bi(fi, -p, Hi.len + p), me.shouldShowTooltip(0, Ql.pos - l + Ms, { ignoreX: !0 }) && (Ss = Ql.pos + Ms);
                }
          ...
          !D && it.some((ut) => {
            ...
            return ou(ut, { target: ot, x: bt });
          })), i.cleanSplit(), iu(it, X);
          ...
          eu && M.attr({ opacity: M.opacity === 1 ? 0.999 : 1 });
        }
        drawTracker() {
        ...
        headerFooterFormatter(t, e) {
          ...
          return In(this, "headerFormatter", a, function(c) {
            if (o && !n && nu(t.key) && (n = o.getXDateFormat(t.key, s.dateTimeLabelFormats)), o && n) {
              if (lu(n)) {
                let d = n;
                tu[0] = (u) => i.chart.time.dateFormat(d, u), n = "%0";
              }
              (t.tooltipDateKeys || ["key"]).forEach((d) => {
                l = l.replace(RegExp("point\\." + d + "([ \\)}])"), `(point.${d}:${n})$1`);
              });
            }
            i.chart.styledMode && (l = this.styledModeFormat(l)), c.text = Pn(l, t, this.chart);
          }), a.text || "";
        }
        update(t) {
          this.destroy(), this.init(this.chart, hu(!0, this.options, t));
        }
        updatePosition(t) {
          var S;
          ...
          if (a && i) {
            ...
            T = (r.borderWidth || 0) + 2 * s + 2, a.setSize(Bi(l + T, 0, m.documentElement.clientWidth) - 1, n + T, !1), (g !== 1 || x !== 1) && (En(i, { transform: `scale(${g}, ${x})` }), v *= g, w *= x), v += u - y.x, w += p - y.y;
          }
      ...
      (function(h) {
        h.compose = function(t) {
          du(Jc, "Core.Tooltip") && su(t, "afterInit", function() {
            let e = this.chart;
            e.options.tooltip && (e.tooltip = new h(e, e.options.tooltip, this));
          });
        };
      })(mo || (mo = {}));
      let Dn = mo, { animObject: uu } = Xt, { defaultOptions: pu } = re, { format: fu } = oe, { addEvent: gu, crisp: mu, erase: yu, extend: rr, fireEvent: yo, getNestedProperty: xu, isArray: bu, isFunction: vu, isNumber: We, isObject: or, merge: Bn, pick: He, syncTimeout: wu, removeEvent: Nn, uniqueKey: ku } = V;
      class cs {
        ...
        destroy() {
          if (!this.destroyed) {
            let t = this, e = t.series, i = e.chart, s = e.options.dataSorting, r = i.hoverPoints, o = uu(t.series.chart.renderer.globalAnimation), a = () => {
              for (let n in (t.graphic || t.graphics || t.dataLabel || t.dataLabels) && (Nn(t), t.destroyElements()), t) delete t[n];
            };
            t.legendItem && i.legend.destroyItem(t), r && (t.setState(), yu(r, t), r.length || (i.hoverPoints = null)), t === i.hoverPoint && t.onMouseOut(), s != null && s.enabled ? (this.animateBeforeDestroy(), wu(a, o.duration)) : a(), i.pointCount--;
          }
          this.destroyed = !0;
        }
        destroyElements(t) {
        ...
        getNestedProperty(t) {
          return t ? t.indexOf("custom.") === 0 ? xu(t, this.options) : this[t] : void 0;
        }
        getZone() {
        ...
        constructor(t, e, i) {
          this.formatPrefix = "point", this.visible = !0, this.point = this, this.series = t, this.applyOptions(e, i), this.id ?? (this.id = ku()), this.resolveColor(), this.dataLabelOnNull ?? (this.dataLabelOnNull = t.options.nullInteraction), t.chart.pointCount++, yo(this, "afterInit");
        }
        isValid() {
        ...
        optionsToObject(t) {
          ...
          else if (bu(t)) for (!i && t.length > r && ((a = typeof t[0]) == "string" ? (c = e.xAxis) != null && c.dateTime ? o.x = e.chart.time.parse(t[0]) : o.name = t[0] : a === "number" && (o.x = t[0]), n++); l < r; ) i && t[n] === void 0 || (s[l].indexOf(".") > 0 ? cs.prototype.setNestedProperty(o, t[n], s[l]) : o[s[l]] = t[n]), n++, l++;
        ...
        manageEvent(t) {
          var s, r, o, a, n, l, c;
          let e = Bn(this.series.options.point, this.options), i = (s = e.events) == null ? void 0 : s[t];
          vu(i) && (!((r = this.hcEvents) != null && r[t]) || ((a = (o = this.hcEvents) == null ? void 0 : o[t]) == null ? void 0 : a.map((d) => d.fn).indexOf(i)) === -1) ? ((n = this.importedUserEvent) == null || n.call(this), this.importedUserEvent = gu(this, t, i), this.hcEvents && (this.hcEvents[t].userEvent = !0)) : this.importedUserEvent && !i && ((l = this.hcEvents) != null && l[t]) && ((c = this.hcEvents) != null && c[t].userEvent) && (Nn(this, t), delete this.hcEvents[t], Object.keys(this.hcEvents) || delete this.importedUserEvent);
        }
        setState(t, e) {
          var M, P;
          let i = this.series, s = this.state, r = i.options.states[t || "normal"] || {}, o = pu.plotOptions[i.type].marker && i.options.marker, a = o && o.enabled === !1, n = ((M = o == null ? void 0 : o.states) == null ? void 0 : M[t || "normal"]) || {}, l = n.enabled === !1, c = this.marker || {}, d = i.chart, u = o && i.markerAttribs, p = i.halo, g, x, y, m = i.stateMarkerGraphic, v;
          ...
          } else t && n && (v = c.symbol || i.symbol, m && m.currentSymbol !== v && (m = m.destroy()), g && (m ? m[e ? "animate" : "attr"]({ x: g.x, y: g.y }) : v && (i.stateMarkerGraphic = m = d.renderer.symbol(v, g.x, g.y, g.width, g.height, Bn(o, n)).add(i.markerGroup), m.currentSymbol = v)), !d.styledMode && m && this.state !== "inactive" && m.attr(i.pointAttribs(this, t))), m && (m[t && this.isInside ? "show" : "hide"](), m.element.point = this, m.addClass(this.getClassName(), !0));
          let w = r.halo, T = this.graphic || m, S = (T == null ? void 0 : T.visibility) || "inherit";
          w != null && w.size && T && S !== "hidden" && !this.isCluster ? (p || (i.halo = p = d.renderer.path().add(T.parentGroup)), p.show()[e ? "animate" : "attr"]({ d: this.haloPath(w.size) }), p.attr({ class: "highcharts-halo highcharts-color-" + He(this.colorIndex, i.colorIndex) + (this.className ? " " + this.className : ""), visibility: S, zIndex: -1 }), p.point = this, d.styledMode || p.attr(rr({ fill: this.color || i.color, "fill-opacity": w.opacity }, Tt.filterUserAttributes(w.attributes || {})))) : (P = p == null ? void 0 : p.point) != null && P.haloPath && !p.point.destroyed && p.animate({ d: p.point.haloPath(0) }, null, p.hide), yo(this, "afterSetState", { state: t });
        }
        haloPath(t) {
          let e = this.pos();
          return e ? this.series.chart.renderer.symbols.circle(mu(e[0], 1) - t, e[1] - t, 2 * t, 2 * t) : [];
        }
      }
      let je = cs, { parse: Su } = At, { charts: xo, composed: Mu, isTouchDevice: Cu } = E, { addEvent: ae, attr: Tu, css: bo, extend: vo, find: zn, fireEvent: Xe, isNumber: ar, isObject: nr, objectEach: Au, offset: Ou, pick: Me, pushUnique: Pu, splat: Fn } = V;
      class Ht {
        ...
        destroy() {
          let t = this;
          this.eventsToUnbind.forEach((e) => e()), this.eventsToUnbind = [], !E.chartCount && (Ht.unbindDocumentMouseUp.forEach((e) => e.unbind()), Ht.unbindDocumentMouseUp.length = 0, Ht.unbindDocumentTouchEnd && (Ht.unbindDocumentTouchEnd = Ht.unbindDocumentTouchEnd())), clearInterval(t.tooltipTimeout), Au(t, function(e, i) {
            t[i] = void 0;
          });
        }
        ...
        drag(t) {
          ...
          if ((!m || !m.touch) && (g < n ? g = n : g > n + c && (g = n + c), x < l ? x = l : x > l + d && (x = l + d), this.hasDragged = Math.sqrt(Math.pow(i - g, 2) + Math.pow(s - x, 2)), this.hasDragged > 10)) {
            ...
            (e.hasCartesianSeries || e.mapView) && this.hasZoom && y && !p && !m && (this.selectionMarker = m = e.renderer[v](), m.attr({ class: "highcharts-selection-marker", zIndex: 7 }).add(), e.styledMode || m.attr({ fill: a || Su("#334eff").setOpacity(0.25).get() })), m && m.attr(w), y && !m && u && e.pan(t, r);
          }
        }
        dragStart(t) {
          let e = this.chart;
        ...
        drop(t) {
          ...
          i && ar(i.index) && (bo(i.container, { cursor: i._cursor }), i.cancelClick = this.hasDragged > 10, i.mouseIsDown = !1, this.hasDragged = 0, this.pinchDown = []);
        }
        ...
        getChartPosition() {
          ...
          let { container: t } = this.chart, e = Ou(t);
        ...
        getHoverData(t, e, i, s, r, o) {
          ...
          return l = u == null ? void 0 : u.series, u && (r && !l.noSharedTooltip ? (c = i.filter(function(p) {
            ...
            var y;
            let g = (y = p.options) == null ? void 0 : y.nullInteraction, x = zn(p.points, function(m) {
        ...
        normalize(t, e) {
          ...
          return vo(t, { chartX: Math.round(r /= e.scaleX), chartY: Math.round(o /= e.scaleY) });
        }
        onContainerClick(t) {
          let e = this.chart, i = e.hoverPoint, s = this.normalize(t), r = e.plotLeft, o = e.plotTop;
          !e.cancelClick && (i && this.inClass(s.target, "highcharts-tracker") ? (Xe(i.series, "click", vo(s, { point: i })), e.hoverPoint && i.firePointEvent("click", s)) : (vo(s, this.getCoordinates(s)), e.isInsidePlot(s.chartX - r, s.chartY - o, { visiblePlotOnly: !0 }) && Xe(e, "click", s)));
        }
        ...
        onContainerMouseLeave(t) {
          let { pointer: e } = xo[Me(Ht.hoverChartIndex, -1)] || {};
        ...
        onDocumentMouseUp(t) {
          var e, i;
          (i = (e = xo[Me(Ht.hoverChartIndex, -1)]) == null ? void 0 : e.pointer) == null || i.drop(t);
        }
        pinch(t) {
        ...
        reset(t, e) {
          ...
          t && n && Fn(n).forEach(function(l) {
            l.series.isCartesian && l.plotX === void 0 && (t = !1);
          }), t ? a && n && Fn(n).length && (a.refresh(n), a.shared && o ? o.forEach(function(l) {
        ...
        runPointActions(t, e, i) {
          ...
          this.unDocMouseMove || (this.unDocMouseMove = ae(s.container.ownerDocument, "mousemove", (y) => {
            var m, v;
            return (v = (m = xo[Ht.hoverChartIndex ?? -1]) == null ? void 0 : m.pointer) == null ? void 0 : v.onDocumentMouseMove(y);
          }), this.eventsToUnbind.push(this.unDocMouseMove)), s.axes.forEach(function(y) {
            var w;
            let m, v = ((w = y.crosshair) == null ? void 0 : w.snap) ?? !0;
            !v || (m = s.hoverPoint) && m.series[y.coll] === y || (m = zn(u, (T) => {
              var S;
        ...
        setPointerCapture() {
          ...
          })), e.styledMode || bo(i, { "touch-action": "none" }), i.className += " highcharts-no-touch-action", this.hasPointerCapture = !0) : this.hasPointerCapture && !s && (t.forEach((a) => a()), t.length = 0, e.styledMode || bo(i, { "touch-action": Me((o = e.options.chart.style) == null ? void 0 : o["touch-action"], "manipulation") }), i.className = i.className.replace(" highcharts-no-touch-action", ""), this.hasPointerCapture = !1);
        }
      ...
      Ht.unbindDocumentMouseUp = [], function(h) {
        h.compose = function(t) {
          Pu(Mu, "Core.Pointer") && ae(t, "beforeRender", function() {
      ...
      let { setLength: Lu, splice: Hn } = nt, { fireEvent: wo, objectEach: us, uniqueKey: ps } = V, lr = class {
        constructor(h = {}) {
        ...
        applyRowCount(h) {
          this.rowCount = h, us(this.columns, (t, e) => {
            t.length !== h && (this.columns[e] = Lu(t, h));
          });
        }
        deleteRows(h, t = 1) {
          if (t > 0 && h < this.rowCount) {
            let e = 0;
            us(this.columns, (i, s) => {
              this.columns[s] = Hn(i, h, t).array, e = i.length;
            }), this.rowCount = e;
          }
          wo(this, "afterDeleteRows", { rowIndex: h, rowCount: t }), this.versionTag = ps();
        }
        getColumn(h, t) {
        ...
        setColumns(h, t, e) {
          ...
          }), this.applyRowCount(i), e != null && e.silent || (wo(this, "afterSetColumns"), this.versionTag = ps());
        }
        setRow(h, t = this.rowCount, e, i) {
          let { columns: s } = this, r = e ? this.rowCount + 1 : t + 1;
          us(h, (o, a) => {
            let n = s[a] || (i == null ? void 0 : i.addColumns) !== !1 && Array(r);
            n && (e ? n = Hn(n, t, 0, !0, [o]).array : n[t] = o, s[a] = n);
          }), r > this.rowCount && this.applyRowCount(r), i != null && i.silent || (wo(this, "afterSetRows"), this.versionTag = ps());
        }
      }, { extend: Eu, merge: Iu, pick: jn } = V;
      (function(h) {
        function t(e, i, s) {
          var T, S;
          ...
          if (v && v.enabled !== !1 && l) {
            let M = Math.min(jn(v.radius, u), u);
            d.indexOf("url") === 0 && (v = Iu(v, { width: c, height: c }), M = 0), r.symbol = m = p.symbol(d, l / 2 - M, x - M, 2 * M, 2 * M, Eu({ context: "legend" }, v)).addClass("highcharts-point").add(g), m.isMarker = !0;
          }
        }
        h.areaMarker = function(e, i) {
          ...
          s.symbol = this.chart.renderer.rect(a ? (e.symbolWidth - o) / 2 : 0, e.baseline - o + 1, n, o, jn(e.options.symbolRadius, o / 2)).addClass("highcharts-point").attr({ zIndex: 3 }).add(s.group);
        };
      })($ || ($ = {}));
      let Xn = $, { defaultOptions: Gn } = re, { extend: Ru, extendClass: Du, merge: Bu } = V;
      (function(h) {
        function t(e, i) {
          let s = Gn.plotOptions || {}, r = i.defaultOptions, o = i.prototype;
        ...
        h.seriesTypes = E.seriesTypes, h.registerSeriesType = t, h.seriesType = function(e, i, s, r, o) {
          let a = Gn.plotOptions || {};
          if (i = i || "", a[e] = Bu(a[i], s), delete h.seriesTypes[e], t(e, Du(h.seriesTypes[i] || function() {
          }, r)), h.seriesTypes[e].prototype.type = e, o) {
            class n extends je {
            }
            Ru(n.prototype, o), h.seriesTypes[e].prototype.pointClass = n;
          }
          return h.seriesTypes[e];
        };
      })(K || (K = {}));
      let Lt = K, { animObject: Yn, setAnimation: Nu } = Xt, { defaultOptions: hr } = re, { registerEventOptions: zu } = Ks, { svg: Fu, win: Wu } = E, { seriesTypes: zi } = Lt, { format: Hu } = oe, { arrayMax: ko, arrayMin: Un, clamp: qn, correctFloat: $n, crisp: ju, defined: zt, destroyObjectProperties: Xu, diffObjects: Gu, erase: Vn, error: dr, extend: Fi, find: Yu, fireEvent: Et, getClosestDistance: Uu, getNestedProperty: Kn, insertItem: Qn, isArray: _n, isNumber: jt, isString: qu, merge: fs, objectEach: So, pick: Pt, removeEvent: $u, syncTimeout: Zn } = V;
      class fe {
        constructor() {
          this.zoneAxis = "y";
        }
        init(t, e) {
          ...
          this.linkedSeries = [], this.bindAxes(), Fi(this, { name: r.name, state: "", visible: o, selected: r.selected === !0 }), zu(this, r);
          let a = r.events;
          (a != null && a.click || (l = (n = r.point) == null ? void 0 : n.events) != null && l.click || r.allowPointSelect) && (t.runTrackerClick = !0), this.getColor(), this.getSymbol(), this.isCartesian && (t.hasCartesianSeries = !0), s.length && (i = s[s.length - 1]), this._i = Pt(i == null ? void 0 : i._i, -1) + 1, this.opacity = this.options.opacity, t.orderItems("series", Qn(this, s)), (c = r.dataSorting) != null && c.enabled ? this.setDataSortingOptions() : this.points || this.data || this.setData(r.data, !1), Et(this, "afterInit");
        }
        is(t) {
          ...
          Et(this, "bindAxes", null, function() {
            (e.axisTypes || []).forEach(function(r) {
              (s[r] || []).forEach(function(o) {
                t = o.options, (Pt(i[r], 0) === o.index || i[r] !== void 0 && i[r] === t.id) && (Qn(e, o.series), e[r] = o, o.isDirty = !0);
        ...
        getName() {
          return this.options.name ?? Hu(this.chart.options.lang.seriesName, this, this.chart);
        }
        getCyclic(t, e, i) {
        ...
        findPointIndex(t, e) {
          ...
          if (o) {
            ...
            if (l != null && l.matchByName ? u = (p) => !p.touched && p.name === t.name : this.options.relativeXValue && (u = (p) => !p.touched && p.options.x === t.x), !(i = Yu(n, u))) return;
          }
        ...
        updateData(t, e) {
          ...
          return this.xIncrement === null && g.length && (this.xIncrement = ko(g), this.autoIncrement()), !0;
        }
        dataColumnKeys() {
        ...
        setData(t, e = !0, i, s) {
          ...
          if (l != null && l.enabled && (t = this.sortData(t)), n.options.chart.allowMutatingData && s !== !1 && M && o && !this.cropped && !this.hasGroupedData && this.visible && !this.boosted && (v = this.updateData(t, i)), !v) {
            ...
            let L = d && M > d;
            if (L) {
              let R = this.getFirstValidPoint(t), D = this.getFirstValidPoint(t, M - 1, -1), N = (B) => !!(_n(B) && (y || jt(B[0])));
              if (jt(R) && jt(D)) {
                let B = [], X = [];
            ...
            for (qu(this.getColumn("y")[0]) && dr(14, !0, n), this.data = [], this.options.data = this.userOptions.data = t, m = o; m--; ) (A = r[m]) == null || A.destroy();
        ...
        getExtremes(t, e) {
          ...
          let T = { activeYData: d, dataMin: Un(d), dataMax: ko(d) };
        ...
        translate() {
          ...
          for (p = 0; p < a; p++) {
            ...
            S.plotX = jt(g = i.translate(M, !1, !1, !1, !0, n)) ? $n(v(g)) : void 0, e && this.visible && D && D[M] && (y = this.getStackIndicator(y, M, this.index), !S.isNull && y.key && (A = (P = D[M]).points[y.key]), P && _n(A) && (R = A[0], L = A[1], R === d && y.key === D[M].base && (R = Pt(jt(c) ? c : r.min)), r.positiveValuesOnly && zt(R) && R <= 0 && (R = void 0), S.total = S.stackTotal = Pt(P.total), S.percentage = zt(S.y) && P.total ? S.y / P.total * 100 : void 0, S.stackY = L, this.irregularWidths || P.setOffset(this.pointXOffset || 0, this.barW || 0, void 0, void 0, void 0, this.xAxis))), S.yBottom = zt(R) ? v(r.translate(R, !1, !0, !1, !0)) : void 0, this.dataModify && (L = this.dataModify.modifyValue(L, p)), jt(L) && S.plotX !== void 0 ? T = jt(T = r.translate(L, !1, !0, !1, !0)) ? v(T) : void 0 : !jt(L) && u && (T = u), S.plotY = T, S.isInside = this.isPointInside(S), S.clientX = l ? $n(i.translate(M, !1, !1, !1, !0, n)) : g, S.negative = (S.y || 0) < (c || 0), S.isNull || S.visible === !1 || (x !== void 0 && (m = Math.min(m, Math.abs(g - x))), x = g), S.zone = this.zones.length ? S.getZone() : void 0, !S.graphic && this.group && s && (S.isNew = !0);
          }
        ...
        animate(t) {
          let { chart: e, group: i, markerGroup: s } = this, r = e.inverted, o = Yn(this.options.animation), a = [this.getSharedClipKey(), o.duration, o.easing, o.defer].join(","), n = e.sharedClips[a], l = e.sharedClips[a + "m"];
          if (t && i) {
        ...
        afterAnimate() {
          this.setClip(), So(this.chart.sharedClips, (t, e, i) => {
        ...
        markerAttribs(t, e) {
          ...
          let d = t.pos();
          return jt(c) && d && (i.crisp && (d[0] = ju(d[0], t.hasImage ? 0 : o === "rect" ? (s == null ? void 0 : s.lineWidth) || 0 : 1)), a.x = d[0] - c, a.y = d[1] - c), c && (a.width = a.height = 2 * c), a;
        }
        pointAttribs(t, e) {
          var m;
        ...
        destroy(t) {
          var n, l;
          let e, i, s = this, r = s.chart, o = /AppleWebKit\/533/.test(Wu.navigator.userAgent), a = s.data || [];
          for (Et(s, "destroy", { keepEventsForUpdate: t }), this.removeEvents(t), (s.axisTypes || []).forEach(function(c) {
            i = s[c], i != null && i.series && (Vn(i.series, s), i.isDirty = i.forceRedraw = !0);
          }), s.legendItem && s.chart.legend.destroyItem(s), e = a.length; e--; ) (l = (n = a[e]) == null ? void 0 : n.destroy) == null || l.call(n);
          for (let c of s.zones) Xu(c, void 0, !0);
          V.clearTimeout(s.animationTimeout), So(s, function(c, d) {
            c instanceof we && !c.survive && c[o && d === "group" ? "hide" : "destroy"]();
          }), r.hoverSeries === s && (r.hoverSeries = void 0), Vn(r.series, s), r.orderItems("series"), So(s, function(c, d) {
        ...
        applyZones() {
          ...
          if (s.length && (i || t) && d && jt(d.min)) {
            ...
            if (s.forEach((S) => {
              S.lineClip = [], S.translated = qn(d.toPixels(Pt(S.value, m), !0) || 0, 0, p);
        ...
        drawTracker() {
          ...
          }, c = "rgba(192,192,192," + (Fu ? 1e-4 : 2e-3) + ")", d = t.tracker;
        ...
        removePoint(t, e, i) {
          ...
          Nu(i, r), e = Pt(e, !0), l ? l.firePointEvent("remove", null, c) : c();
        }
        remove(t, e, i, s) {
        ...
        update(t, e) {
          var m, v;
          Et(this, "update", { options: t = Gu(t, this.userOptions) });
        ...
        drawLegendSymbol(t, e) {
          var i;
          (i = Xn[this.options.legendSymbol || "rectangle"]) == null || i.call(this, t, e);
        }
      }
      ...
      let ie = fe, { animObject: Vu, setAnimation: Ku } = Xt, { registerEventOptions: Jn } = Ks, { composed: Qu, marginNames: tl } = E, { distribute: _u } = Ws, { format: Zu } = oe, { addEvent: cr, createElement: Ju, css: tp, defined: Mo, discardElement: ep, find: ip, fireEvent: Ee, isNumber: el, merge: di, pick: ne, pushUnique: sp, relativeLength: rp, stableSort: op, syncTimeout: ap } = V;
      class Co {
        constructor(t, e) {
          this.allItems = [], this.initialItemY = 0, this.itemHeight = 0, this.itemMarginBottom = 0, this.itemMarginTop = 0, this.itemX = 0, this.itemY = 0, this.lastItemY = 0, this.lastLineHeight = 0, this.legendHeight = 0, this.legendWidth = 0, this.maxItemWidth = 0, this.maxLegendWidth = 0, this.offsetWidth = 0, this.padding = 0, this.pages = [], this.symbolHeight = 0, this.symbolWidth = 0, this.titleHeight = 0, this.totalItemWidth = 0, this.widthOption = 0, this.chart = t, this.setOptions(e), e.enabled && (this.render(), Jn(this, e), cr(this.chart, "endResize", function() {
        ...
        update(t, e) {
          let i = this.chart;
          this.setOptions(di(!0, this.options, t)), "events" in this.options && Jn(this, this.options), this.destroy(), i.isDirtyLegend = i.isDirtyBox = !0, ne(e, !0) && i.redraw(), Ee(this, "afterUpdate", { redraw: e });
        }
        colorizeItem(t, e) {
          var l;
        ...
        positionItem(t) {
          ...
          if (e != null && e.element) {
            ...
            e[Mo(e.translateY) ? "animate" : "attr"](l, void 0, () => {
        ...
        positionCheckboxes() {
          ...
          e && (t = e.translateY, this.allItems.forEach(function(o) {
            let a, n = o.checkbox;
            n && (a = t + s + n.y + (this.scrollOffset || 0) + 3, tp(n, { left: e.translateX + o.checkboxOffset + n.x - 20 + "px", top: a + "px", display: this.proximate || a > t - 6 && a < t + i - 6 ? "" : "none" }));
          }, this));
        }
        renderTitle() {
        ...
        setText(t) {
          let e = this.options;
          t.legendItem.label.attr({ text: e.labelFormat ? Zu(e.labelFormat, t, this.chart) : e.labelFormatter.call(t) });
        }
        renderItem(t) {
          var P;
        ...
        getAllItems() {
          ...
          return this.chart.series.forEach(function(e) {
            ...
            e && ne(i.showInLegend, !Mo(i.linkedTo) && void 0, !0) && (t = t.concat(((s = e.legendItem) == null ? void 0 : s.labels) || (i.legendType === "point" ? e.data : e)));
        ...
        adjustMargins(t, e) {
          ...
          r && [/(lth|ct|rth)/, /(rtv|rm|rbv)/, /(rbh|cb|lbh)/, /(lbv|lm|ltv)/].forEach(function(o, a) {
            o.test(r) && !Mo(t[a]) && (i[tl[a]] = Math.max(i[tl[a]], i.legend[(a + 1) % 2 ? "legendHeight" : "legendWidth"] + [1, -1, -1, 1][a] * s[a % 2 ? "x" : "y"] + ne(s.margin, 12) + e[a] + (i.titleOffset[a] || 0)));
          });
        }
        proximatePositions() {
          ...
          for (let r of (this.allItems.forEach(function(o) {
            let a, n, l = s, c, d;
            o.yAxis && (o.xAxis.options.reversed && (l = !l), o.points && (a = ip(l ? o.points : o.points.slice(0).reverse(), function(u) {
              return el(u.plotY);
          ...
          }, this), _u(i, e.plotHeight))) t = r.item.legendItem || {}, el(r.pos) && (t.y = e.plotTop - e.spacing[0] + r.pos);
        }
        render() {
          let t = this.chart, e = t.renderer, i = this.options, s = this.padding, r = this.getAllItems(), o, a, n, l = this.group, c, d = this.box;
          this.itemX = s, this.itemY = this.initialItemY, this.offsetWidth = 0, this.lastItemY = 0, this.widthOption = rp(i.width, t.spacingBox.width - s), c = t.spacingBox.width - 2 * s - i.x, ["rm", "lm"].indexOf(this.getAlignment().substring(0, 2)) > -1 && (c /= 2), this.maxLegendWidth = this.widthOption || c, l || (this.group = l = e.g("legend").addClass(i.className || "").attr({ zIndex: 7 }).add(), this.contentGroup = e.g().attr({ zIndex: 1 }).add(l), this.scrollGroup = e.g().add(this.contentGroup)), this.renderTitle(), op(r, (u, p) => {
            var g, x;
        ...
        scroll(t, e) {
          ...
          c > r && (c = r), c > 0 && (e !== void 0 && Ku(e, i), this.nav.attr({ translateX: l, translateY: o + this.padding + 7 + this.titleHeight, visibility: "inherit" }), [this.up, this.upTracker].forEach(function(d) {
        ...
        createCheckboxForItem(t) {
          t.checkbox = Ju("input", { type: "checkbox", className: "highcharts-legend-checkbox", checked: t.selected, defaultChecked: t.selected }, this.options.itemCheckboxStyle, this.chart.container), cr(t.checkbox, "click", function(e) {
            let i = e.target;
      ...
      (function(h) {
        h.compose = function(t) {
          sp(Qu, "Core.Legend") && cr(t, "beforeMargins", function() {
            this.legend = new h(this, this.options.legend);
          });
        };
      })(Co || (Co = {}));
      let il = Co, { animate: To, animObject: np, setAnimation: Ao } = Xt, { defaultOptions: Oo } = re, { numberFormat: lp } = oe, { registerEventOptions: sl } = Ks, { charts: ci, doc: gs, marginNames: rl, svg: hp, win: ol } = E, { seriesTypes: Po } = Lt, { addEvent: Lo, attr: al, createElement: Eo, css: ge, defined: Ge, diffObjects: nl, discardElement: dp, erase: cp, error: Io, extend: Ye, find: Ro, fireEvent: gt, getAlignFactor: up, getStyle: Do, isArray: pp, isNumber: Wi, isObject: fp, isString: ur, merge: Ce, objectEach: Bo, pick: Gt, pInt: gp, relativeLength: ll, removeEvent: hl, splat: pr, syncTimeout: mp, uniqueKey: yp } = V;
      class Ue {
        static chart(t, e, i) {
          return new Ue(t, e, i);
        }
        ...
        init(t, e) {
          gt(this, "init", { args: arguments }, function() {
            var o;
            let i = Ce(Oo, t), s = i.chart, r = this.renderTo || s.renderTo;
            this.userOptions = Ye({}, t), (this.renderTo = ur(r) ? gs.getElementById(r) : r) || Io(13, !0, this), this.margin = [], this.spacing = [], this.labelCollectors = [], this.callback = e, this.isResizing = 0, this.options = i, this.axes = [], this.series = [], this.locale = i.lang.locale ?? ((o = this.renderTo.closest("[lang]")) == null ? void 0 : o.lang), this.time = new Xr(Ye(i.time || {}, { locale: this.locale }), i.lang), i.time = this.time.options, this.numberFormatter = (s.numberFormatter || lp).bind(this), this.styledMode = s.styledMode, this.hasCartesianSeries = s.showAxes, this.index = ci.length, ci.push(this), E.chartCount++, sl(this, s), this.xAxis = [], this.yAxis = [], this.pointCount = this.colorCounter = this.symbolCounter = 0, this.setZoomOptions(), gt(this, "afterInit"), this.firstRender();
          });
        }
        initSeries(t) {
          let e = this.options.chart, i = t.type || e.type, s = Po[i];
          s || Io(17, !0, this, { missingModuleFor: i });
          let r = new s();
        ...
        redraw(t) {
          ...
          for (a.rootFontSize = a.boxWrapper.getStyle("font-size"), this.setResponsive && this.setResponsive(!1), Ao(!!this.hasRendered && t, this), n && this.temporaryDisplay(), this.layOutTitles(!1), u = i.length; u--; ) if (((x = i[u]).options.stacking || x.options.centerInCategory) && (d = !0, x.isDirty)) {
            c = !0;
            break;
          }
        ...
        get(t) {
          ...
          let s = Ro(this.axes, i) || Ro(this.series, i);
          for (let r = 0; !s && r < e.length; r++) s = Ro(e[r].points || [], i);
          return s;
        }
        createAxes() {
        ...
        layOutTitles(t = !0) {
          ...
          ["title", "subtitle", "caption"].forEach((d) => {
            ...
            if (u && p) {
              ...
              if (R.height = N, u.align(R, !1, g).attr({ align: R.align, scaleX: L, scaleY: L, "transform-origin": `${g.x + x * L * up(R.align)} ${w}` }), !p.floating) {
                let B = N * (N < 1.2 * w ? 1 : L);
        ...
        getContainerBox() {
          ...
          }), e = { width: Do(this.renderTo, "width", !0) || 0, height: Do(this.renderTo, "height", !0) || 0 };
        ...
        getChartSize() {
          ...
          this.chartWidth = Math.max(0, e || s.width || 600), this.chartHeight = Math.max(0, ll(i, this.chartWidth) || (r ? 400 : s.height)), this.containerBox = s;
        }
        temporaryDisplay(t) {
          ...
          else for (; e != null && e.style && (gs.body.contains(e) || e.parentNode || (e.hcOrigDetached = !0, gs.body.appendChild(e)), (Do(e, "display", !1) === "none" || e.hcOricDetached) && (e.hcOrigStyle = { display: e.style.display, height: e.style.height, overflow: e.style.overflow }, i = { display: "block", overflow: "hidden" }, e !== this.renderTo && (i.height = 0), ge(e, i), e.offsetWidth || e.style.setProperty("display", "block", "important")), (e = e.parentNode) !== gs.body); ) ;
        }
        setClassName(t) {
        ...
        getContainer() {
          var u, p;
          let t, e = this.options, i = e.chart, s = "data-highcharts-chart", r = yp(), o = this.renderTo, a = gp(al(o, s));
          Wi(a) && ci[a] && ci[a].hasRendered && ci[a].destroy(), al(o, s, this.index), o.innerHTML = Tt.emptyHTML, i.skipClone || o.offsetWidth || this.temporaryDisplay(), this.getChartSize();
          ...
          let d = i.renderer || !hp ? os.getRendererType(i.renderer) : $s;
          if (this.renderer = new d(c, l, n, void 0, i.forExport, (p = e.exporting) == null ? void 0 : p.allowHTML, this.styledMode), Ao(void 0, this), this.setClassName(i.className), this.styledMode) for (let g in e.defs) this.renderer.definition(e.defs[g]);
        ...
        getAxisMargins() {
          ...
          t.hasCartesianSeries ? r(t.axes) : i != null && i.length && r(i), rl.forEach(function(o, a) {
            Ge(s[a]) || (t[o] += e[a]);
          }), t.setChartSize();
        }
        getOptions() {
          return nl(this.userOptions, Oo);
        }
        reflow(t) {
          var r;
          let e = this, i = e.containerBox, s = e.getContainerBox();
          (r = e.pointer) == null || delete r.chartPosition, !e.isPrinting && !e.isResizing && i && s.width && ((s.width !== i.width || s.height !== i.height) && (V.clearTimeout(e.reflowTimeout), e.reflowTimeout = mp(function() {
        ...
        setReflow() {
          ...
          if (typeof ResizeObserver == "function") new ResizeObserver(e).observe(t.renderTo);
            ...
            let i = Lo(ol, "resize", e);
            Lo(this, "destroy", i);
          }
        }
        setSize(t, e, i) {
          let s = this, r = s.renderer;
          s.isResizing += 1, Ao(i, s);
          ...
          (s.isDirtyBox || a !== s.oldChartWidth || n !== s.oldChartHeight) && (s.styledMode || (o ? To : ge)(s.container, { width: `${a + l}px`, height: `${n + c}px` }, o), s.setChartSize(!0), r.setSize(a, n, o), s.axes.forEach(function(d) {
        ...
        resetMargins() {
          ...
          ["margin", "spacing"].forEach(function(r) {
            let o = e[r], a = fp(o) ? o : [o, o, o, o];
            ["Top", "Right", "Bottom", "Left"].forEach(function(n, l) {
              t[r][l] = Gt(e[r + n], a[l]);
            });
          }), rl.forEach(function(r, o) {
        ...
        propFromSeries() {
          ...
          ["inverted", "angular", "polar"].forEach(function(a) {
            for (e = Po[r.type], i = r[a] || e && e.prototype[a], t = o == null ? void 0 : o.length; !i && t--; ) (e = Po[o[t].type]) && e.prototype[a] && (i = !0);
            s[a] = i;
          });
        }
        linkSeries(t) {
        ...
        addCredits(t) {
          ...
          i.enabled && !this.credits && (this.credits = this.renderer.text(i.text + (this.mapCredits || ""), 0, 0).addClass("highcharts-credits").on("click", function() {
            i.href && (ol.location.href = i.href);
        ...
        destroy() {
          ...
          for (gt(e, "destroy"), e.renderer.forExport ? cp(ci, e) : ci[e.index] = void 0, E.chartCount--, e.renderTo.removeAttribute("data-highcharts-chart"), hl(e), t = i.length; t--; ) i[t] = i[t].destroy();
          ...
          }), r && (r.innerHTML = Tt.emptyHTML, hl(r), o && dp(r)), Bo(e, function(l, c) {
            delete e[c];
          });
        }
        firstRender() {
        ...
        warnIfA11yModuleNotLoaded() {
          ...
          !t || this.accessibility || (this.renderer.boxWrapper.attr({ role: "img", "aria-label": ((e == null ? void 0 : e.element.textContent) || "").replace(/</g, "&lt;") }), t.accessibility && t.accessibility.enabled === !1 || Io('Highcharts warning: Consider including the "accessibility.js" module to make your chart more usable for people with disabilities. Set the "accessibility.enabled" option to false to remove this warning. See https://www.highcharts.com/docs/accessibility/accessibility-module.', !1, this));
        }
        addSeries(t, e, i) {
          let s, r = this;
        ...
        showLoading(t) {
          ...
          o || (e.loadingDiv = o = Eo("div", { className: "highcharts-loading highcharts-loading-hidden" }, null, e.container)), a || (e.loadingSpan = a = Eo("span", { className: "highcharts-loading-inner" }, null, o), Lo(e, "redraw", r)), o.className = "highcharts-loading", Tt.setElementHTML(a, Gt(t, i.lang.loading, "")), e.styledMode || (ge(o, Ye(s.style, { zIndex: 10 })), ge(a, s.labelStyle), e.loadingShown || (ge(o, { opacity: 0, display: "" }), To(o, { opacity: s.style.opacity || 0.5 }, { duration: s.showDuration || 0 }))), e.loadingShown = !0, r();
        }
        hideLoading() {
          let t = this.options, e = this.loadingDiv;
          e && (e.className = "highcharts-loading highcharts-loading-hidden", this.styledMode || To(e, { opacity: 0 }, { duration: t.loading.hideDuration || 100, complete: function() {
            ge(e, { display: "none" });
          } })), this.loadingShown = !1;
        }
        update(t, e, i, s) {
          let r, o, a, n = this, l = { credits: "addCredits", title: "setTitle", subtitle: "setSubtitle", caption: "setCaption" }, c = t.isResponsiveOptions, d = [];
          gt(n, "update", { options: t }), c || n.setResponsive(!1, !0), t = nl(t, n.options), n.userOptions = Ce(n.userOptions, t);
          let u = t.chart;
          u && (Ce(!0, n.options.chart, u), this.setZoomOptions(), "className" in u && n.setClassName(u.className), ("inverted" in u || "polar" in u || "type" in u) && (n.propFromSeries(), r = !0), "alignTicks" in u && (r = !0), "events" in u && sl(this, u), Bo(u, function(x, y) {
          ...
          }), !n.styledMode && u.style && n.renderer.setStyle(n.options.chart.style || {})), !n.styledMode && t.colors && (this.options.colors = t.colors), Bo(t, function(x, y) {
          ...
          let p = u == null ? void 0 : u.width, g = u && (ur(u.height) ? ll(u.height, p || n.chartWidth) : u.height);
        ...
        showResetZoom() {
          let t = this, e = Oo.lang, i = t.zooming.resetButton, s = i.theme, r = i.relativeTo === "chart" || i.relativeTo === "spacingBox" ? null : "plotBox";
          function o() {
            t.zoomOut();
          }
      ...
      let { stop: xp } = Xt, { composed: bp } = E, { addEvent: qe, createElement: fr, css: No, defined: zo, erase: vp, merge: dl, pushUnique: cl } = V;
      function wp() {
      ...
      class ms {
        static compose(t, e, i) {
          cl(bp, this.compose) && (qe(t, "afterInit", ul), qe(e, "afterSetChartSize", (s) => this.afterSetSize(s.target, s)), qe(e, "render", wp), qe(i, "show", ul));
        }
        static afterSetSize(t, e) {
          ...
          if (!d.forExport && (o ? (t.scrollablePixelsX = i = Math.max(0, o - t.chartWidth), i && (t.scrollablePlotBox = dl(t.plotBox), l.width = t.plotWidth += i, n[c ? "height" : "width"] += i, r = !0)) : a && (t.scrollablePixelsY = s = Math.max(0, a - t.chartHeight), zo(s) && (t.scrollablePlotBox = dl(t.plotBox), l.height = t.plotHeight += s, n[c ? "width" : "height"] += s, r = !1)), zo(r) && !e.skipAxes)) for (let u of t.axes) (u.horiz === r || t.hasParallelCoordinates && u.coll === "yAxis") && (u.setAxisSize(), u.setAxisTranslation());
        }
        constructor(t) {
          var p;
          ...
          this.mask = u.path().attr({ fill: i.backgroundColor || "#fff", "fill-opacity": r.opacity ?? 0.85, zIndex: -1 }).addClass("highcharts-scrollable-mask").add(), l.parentNode.insertBefore(d, l), No(t.renderTo, { overflow: "visible" }), qe(t, "afterShowResetZoom", o), qe(t, "afterApplyDrilldown", o), qe(t, "afterLayOutTitles", o), qe(l, "scroll", () => {
        ...
        applyFixed() {
          ...
          e.setSize(o, a), (i ?? !0) && (this.isDirty = !1, this.moveFixedElements()), xp(t.container), No(n, { width: `${m}px`, height: `${v}px` }), t.renderer.boxWrapper.attr({ width: m, height: v, viewBox: [0, 0, m, v].join(" ") }), (R = t.chartBackground) == null || R.attr({ width: m, height: v }), No(s, { width: `${o}px`, height: `${a}px` }), zo(i) || (s.scrollLeft = p * x, s.scrollTop = g * y);
        ...
        moveFixedElements() {
          ...
          if (s && !i ? t = ".highcharts-yaxis" : s && i || r && !i ? t = ".highcharts-xaxis" : r && i && (t = ".highcharts-yaxis"), t && !(this.chart.hasParallelCoordinates && t === ".highcharts-yaxis")) for (let n of [`${t}:not(.highcharts-radial-axis)`, `${t}-labels:not(.highcharts-radial-axis-labels)`]) cl(a, n);
          else for (let n of [".highcharts-xaxis", ".highcharts-yaxis"]) for (let l of [`${n}:not(.highcharts-radial-axis)`, `${n}-labels:not(.highcharts-radial-axis-labels)`]) vp(a, l);
      ...
      let { format: kp } = oe, { series: Sp } = Lt, { destroyObjectProperties: Mp, fireEvent: pl, getAlignFactor: Fo, isNumber: Wo, pick: ys } = V, fl = class {
        constructor(h, t, e, i, s) {
        ...
        render(h) {
          let t = this.axis.chart, e = this.options, i = e.format, s = i ? kp(i, this, t) : e.formatter.call(this);
          ...
          this.label.labelrank = t.plotSizeY, pl(this, "afterRender");
        }
        setOffset(h, t, e, i, s, r) {
          ...
          if (n && u) {
            ...
            u.x -= v, u.y -= w, n.align(o, !1, u), (m = d.isInsidePlot(n.alignAttr.x + o.x + v, n.alignAttr.y + o.y + w)) || (y = !1), y && Sp.prototype.justifyDataLabel.call(a, n, o, n.alignAttr, g, u), n.attr({ x: n.alignAttr.x, y: n.alignAttr.y, rotation: l.rotation, rotationOriginX: g.width * Fo(l.textAlign || "center"), rotationOriginY: g.height / 2 }), ys(!y && l.crop, !0) && (m = Wo(n.x) && Wo(n.y) && d.isInsidePlot(n.x - x + (n.width || 0), n.y) && d.isInsidePlot(n.x + x, n.y)), n[m ? "show" : "hide"]();
          }
          pl(this, "afterSetOffset", { xOffset: h, width: t });
        }
        adjustStackPosition({ labelBox: h, verticalAlign: t, textAlign: e }) {
          return { x: h.width / 2 + h.width / 2 * (2 * Fo(e) - 1), y: h.height / 2 * 2 * (1 - Fo(t)) };
        }
        getStackBox(h) {
          let t = this.axis, e = t.chart, { boxTop: i, defaultX: s, xOffset: r, width: o, boxBottom: a } = h, n = t.stacking.usePercentage ? 100 : ys(i, this.total, 0), l = t.toPixels(n), c = h.xAxis || e.xAxis[0], d = ys(s, c.translate(this.x)) + r, u = Math.abs(l - t.toPixels(a || Wo(t.min) && t.logarithmic && t.logarithmic.lin2log(t.min) || 0)), p = e.inverted, g = this.isNegative;
      ...
      }, { getDeferredAnimation: Cp } = Xt, { series: { prototype: Tp } } = Lt, { addEvent: gl, correctFloat: xs, defined: ml, destroyObjectProperties: Ap, fireEvent: Op, isNumber: Ho, objectEach: ui, pick: jo } = V;
      function Pp() {
        let h = this.inverted;
        this.axes.forEach((t) => {
          var e;
          ...
          t.options.stacking && t.reserveSpace() && (t.stackKey = [t.type, jo(t.options.stack, ""), h ? e.top : e.left, h ? e.height : e.width].join(","));
        });
      }
      function Lp() {
        var t;
      ...
      function Ip(h, t, e, i) {
        return !ml(h) || h.x !== t || i && h.stackKey !== i ? h = { x: t, index: 0, key: i, stackKey: i } : h.index++, h.key = [e, t, h.index].join(","), h;
      }
      function Rp() {
      ...
      function Bp(h) {
        (this.is("column") || this.is("columnrange")) && (this.options.centerInCategory && this.chart.series.length > 1 ? Tp.setStackedPoints.call(this, h, "group") : h.stacking.resetStacks());
      }
      function Np(h, t) {
        var A, L;
        ...
        for (S.stacksTouched += 1, n = 0; n < p; n++) {
          let R = c[n] || 0, D = d[n], N = Ho(D) && D || 0;
          a = (e = this.getStackIndicator(e, R, this.index)).key || "", M[o = (i = T && N < (y ? 0 : x)) ? w : v] || (M[o] = {}), M[o][R] || ((A = P[o]) != null && A[R] ? (M[o][R] = P[o][R], M[o][R].total = null) : M[o][R] = new fl(h, h.options.stackLabels, !!i, R, m)), s = M[o][R], D !== null ? (s.points[a] = s.points[this.index] = [jo(s.cumulative, y)], ml(s.cumulative) || (s.base = a), s.touched = S.stacksTouched, e.index > 0 && this.singleStacks === !1 && (s.points[a][0] = s.points[this.index + "," + R + ",0"][0])) : (delete s.points[a], delete s.points[this.index]);
          let B = s.total || 0;
          l === "percent" ? (r = i ? v : w, B = T && ((L = M[r]) != null && L[R]) ? (r = M[r][R]).total = Math.max(r.total || 0, B) + Math.abs(N) : xs(B + Math.abs(N))) : l === "group" ? Ho(D) && B++ : B = xs(B + N), l === "group" ? s.cumulative = (B || 1) - 1 : s.cumulative = xs(jo(s.cumulative, y) + N), s.total = B, D !== null && (s.points[a].push(s.cumulative), u[n] = s.cumulative, s.hasValidPoints = !0);
        }
      ...
      class zp {
        ...
        resetStacks() {
          ui(this.stacks, (t) => {
            ui(t, (e, i) => {
              Ho(e.touched) && e.touched < this.stacksTouched ? (e.destroy(), delete t[i]) : (e.total = null, e.cumulative = null);
            });
          });
        }
        renderStackTotals() {
          var a;
          let t = this.axis, e = t.chart, i = e.renderer, s = this.stacks, r = Cp(e, ((a = t.options.stackLabels) == null ? void 0 : a.animation) || !1), o = this.stackTotalGroup = this.stackTotalGroup || i.g("stack-labels").attr({ zIndex: 6, opacity: 0 }).add();
      ...
      (J || (J = {})).compose = function(h, t, e) {
        ...
        i.getStacks || (gl(h, "init", Ep), gl(h, "destroy", Lp), i.getStacks = Pp, s.getStackIndicator = Ip, s.modifyStacks = Rp, s.percentStacker = Dp, s.setGroupedPoints = Bp, s.setStackedPoints = Np);
      };
      let Fp = J, { defined: Wp, merge: yl, isObject: Hp } = V;
      class xl extends ie {
        drawGraph() {
        ...
        getGraphPath(t, e, i) {
          ...
          return c && t.reverse(), (l = { right: 1, center: 2 }[l] || l && 3) && c && (l = 4 - l), (t = this.getValidPoints(t, !1, r.nullInteraction || !(r.connectNulls && !e && !i))).forEach(function(d, u) {
            ...
            (d.leftCliff || y != null && y.rightCliff) && !i && (n = !0), m && !Wp(e) && u > 0 ? n = !r.connectNulls : m && !e ? n = !0 : (u === 0 || n ? p = [["M", d.plotX, d.plotY]] : s.getPointSpline ? p = [s.getPointSpline(t, d, u)] : l ? (p = l === 1 ? [["L", y.plotX, x]] : l === 2 ? [["L", (y.plotX + g) / 2, y.plotY], ["L", (y.plotX + g) / 2, x]] : [["L", g, y.plotY]]).push(["L", g, x]) : p = [["L", g, x]], a.push(d.x), l && (a.push(d.x), l === 2 && a.push(d.x)), o.push.apply(o, p), n = !1);
          }), o.xMap = a, s.graphPath = o, o;
        }
      }
      xl.defaultOptions = yl(ie.defaultOptions, { legendSymbol: "lineMarker" }), Lt.registerSeriesType("line", xl);
      let { seriesTypes: { line: Xo } } = Lt, { extend: jp, merge: Xp, objectEach: Gp, pick: gr } = V;
      class Go extends Xo {
        drawGraph() {
        ...
        getGraphPath(t) {
          let e, i, s, r = Xo.prototype.getGraphPath, o = this.options, a = o.stacking, n = this.yAxis, l = [], c = [], d = this.index, u = n.stacking.stacks[this.stackKey], p = o.threshold, g = Math.round(n.getThreshold(o.threshold)), x = gr(o.connectNulls, a === "percent"), y = function(M, P, A) {
      ...
      Go.defaultOptions = Xp(Xo.defaultOptions, { threshold: 0, legendSymbol: "areaMarker" }), jp(Go.prototype, { singleStacks: !1 }), Lt.registerSeriesType("area", Go);
      let { line: bl } = Lt.seriesTypes, { merge: Yp, pick: mr } = V;
      class Yo extends bl {
      ...
      Yo.defaultOptions = Yp(bl.defaultOptions), Lt.registerSeriesType("spline", Yo);
      let vl = Yo, { area: Up, area: { prototype: Uo } } = Lt.seriesTypes, { extend: qp, merge: $p } = V;
      class qo extends vl {
      }
      qo.defaultOptions = $p(vl.defaultOptions, Up.defaultOptions), qp(qo.prototype, { getGraphPath: Uo.getGraphPath, getStackPoints: Uo.getStackPoints, drawGraph: Uo.drawGraph }), Lt.registerSeriesType("areaspline", qo);
      let { animObject: Vp } = Xt, { parse: Kp } = At, { noop: Qp } = E, { clamp: yr, crisp: xr, defined: wl, extend: kl, fireEvent: Sl, isArray: Ml, isNumber: br, merge: $o, pick: bs, objectEach: _p } = V;
      class vr extends ie {
        animate(t) {
          ...
          t && l ? (d.scaleY = 1e-3, i = yr(r.toPixels(n.threshold || 0), o, o + r.len), c ? d.translateX = (i += a ? -Math.floor(l[0]) : Math.ceil(l[2])) - r.len : d.translateY = i += a ? Math.ceil(l[0]) : -Math.floor(l[2]), s.clipBox && s.setClip(), s.group.attr(d)) : (e = Number(s.group.attr(u)), s.group.animate({ scaleY: 1 }, kl(Vp(s.options.animation), { step: function(p, g) {
        ...
        adjustForMissingColumns(t, e, i, s) {
          ...
          if (!i.isNull && s.columnCount > 1) {
            ...
            _p((r = this.xAxis.stacking) == null ? void 0 : r.stacks, (c) => {
              var g;
        ...
        pointAttribs(t, e) {
          ...
          t && this.zones.length && (n = t.getZone(), c = t.options.color || n && (n.color || t.nonZonedColor) || this.color, n && (d = n.borderColor || d, u = n.dashStyle || u, p = n.borderWidth || p)), e && t && (l = (a = $o(i.states[e], t.options.states && t.options.states[e] || {})).brightness, c = a.color || l !== void 0 && Kp(c).brighten(a.brightness).get() || c, d = a[r] || d, p = a[o] || p, u = a.dashStyle || u, g = bs(a.opacity, g));
        ...
        drawPoints(t = this.points) {
          ...
          t.forEach(function(l) {
            ...
            br(c) && (l.y !== null || o) ? (e = l.shapeArgs, d && l.hasNewShapeType() && (d = d.destroy()), i.enabledDataSorting && (l.startXPos = i.xAxis.reversed ? -(e && e.width || 0) : i.xAxis.width), !d && (l.graphic = d = a[l.shapeType](e).add(l.group || i.group), d && i.enabledDataSorting && s.hasRendered && s.pointCount < n && (d.attr({ x: l.startXPos }), u = !0, p = "animate")), d && u && d[p]($o(e)), s.styledMode || d[p](i.pointAttribs(l, l.selected && "select")).shadow(l.allowShadow !== !1 && r.shadow), d && (d.addClass(l.getClassName(), !0), d.attr({ visibility: l.visible ? "inherit" : "hidden" }))) : d && (l.graphic = d.destroy());
          });
        }
        drawTracker(t = this.points) {
          ...
          t.forEach(function(a) {
            e = Ml(a.dataLabels) ? a.dataLabels : a.dataLabel ? [a.dataLabel] : [], a.graphic && (a.graphic.element.point = a), e.forEach(function(n) {
          ...
          }), i._hasTracking = !0), Sl(this, "afterDrawTracker");
        }
        remove() {
      ...
      vr.defaultOptions = $o(ie.defaultOptions, { borderRadius: 3, centerInCategory: !1, groupPadding: 0.2, marker: null, pointPadding: 0.1, minPointLength: 0, cropThreshold: 50, pointRange: null, states: { hover: { halo: !1, brightness: 0.1 }, select: { color: "#cccccc", borderColor: "#000000" } }, dataLabels: { align: void 0, verticalAlign: void 0, y: void 0 }, startFromThreshold: !0, stickyTracking: !1, tooltip: { distance: 6 }, threshold: 0, borderColor: "#ffffff" }), kl(vr.prototype, { directTouch: !0, getSymbol: Qp, negStacks: !0, trackerGroups: ["group", "dataLabelsGroup"] }), Lt.registerSeriesType("column", vr);
      let wr = vr, { getDeferredAnimation: Zp } = Xt, { format: Jp } = oe, { defined: pi, extend: Cl, fireEvent: Vo, getAlignFactor: Tl, isArray: $e, isString: vs, merge: ws, objectEach: tf, pick: ks, pInt: ef, splat: Al } = V;
      (function(h) {
        function t() {
        ...
        function r(c) {
          ...
          let d;
          c = c || this.points;
          let u = this, p = u.chart, g = u.options, x = p.renderer, { backgroundColor: y, plotBackgroundColor: m } = p.options.chart, v = x.getContrast(vs(m) && m || vs(y) && y || "#000000"), w = n(u), { animation: T, defer: S } = w[0], M = S ? Zp(p, T, u) : { defer: 0, duration: 0 };
          Vo(this, "drawDataLabels"), (P = u.hasDataLabels) != null && P.call(u) && (d = this.initDataLabels(M), c.forEach((A) => {
            var N, B, X;
            let L = A.dataLabels || [], R = A.color || u.color;
            Al(a(w, A.dlOptions || ((N = A.options) == null ? void 0 : N.dataLabels))).forEach((j, it) => {
              var Mt;
              ...
              G && (ut = pi(Yt = ks(j[A.formatPrefix + "Format"], j.format)) ? Jp(Yt, A, p) : (j[A.formatPrefix + "Formatter"] || j.formatter).call(A, j), bt = j.rotation, !p.styledMode && (pt.color = ks(j.color, pt.color, vs(u.color) ? u.color : void 0, "#000000"), pt.color === "contrast" ? (et !== "none" && (vt = et), A.contrastColor = x.getContrast(vt !== "auto" && vs(vt) && vt || (vs(R) ? R : "")), pt.color = vt || !pi(dt) && j.inside || 0 > ef(dt || 0) || g.stacking ? A.contrastColor : v) : delete A.contrastColor, g.cursor && (pt.cursor = g.cursor)), ot = { r: j.borderRadius || 0, rotation: bt, padding: j.padding, zIndex: 1 }, p.styledMode || (ot.fill = et === "auto" ? A.color : et, ot.stroke = ct === "auto" ? A.color : ct, ot["stroke-width"] = j.borderWidth), tf(ot, (Ft, Ie) => {
                Ft === void 0 && delete ot[Ie];
              })), !Q || G && pi(ut) && !!(Q.div || (Mt = Q.text) != null && Mt.foreignObject) == !!j.useHTML && (Q.rotation && j.rotation || Q.rotation === j.rotation) || (Q = void 0, Rt = !0), G && pi(ut) && (Q ? ot.text = ut : (Q = x.label(ut, 0, 0, j.shape, void 0, void 0, j.useHTML, void 0, "data-label")).addClass(" highcharts-data-label-color-" + A.colorIndex + " " + (j.className || "") + (j.useHTML ? " highcharts-tracker" : "")), Q && (Q.options = j, Q.attr(ot), p.styledMode ? pt.width && Q.css({ width: pt.width, textOverflow: pt.textOverflow, whiteSpace: pt.whiteSpace }) : Q.css(pt).shadow(j.shadow), Vo(Q, "beforeAddingDataLabel", { labelOptions: j, point: A }), Q.added || Q.add(d), u.alignDataLabel(A, Q, j, void 0, Rt), Q.isActive = !0, L[it] && L[it] !== Q && L[it].destroy(), L[it] = Q));
            });
            let D = L.length;
            for (; D--; ) (B = L[D]) != null && B.isActive ? L[D].isActive = !1 : ((X = L[D]) == null || X.destroy(), L.splice(D, 1));
            A.dataLabel = L[0], A.dataLabels = L;
          })), Vo(this, "afterDrawDataLabels");
        }
        ...
        function n(c) {
          ...
          return Al(a(a((u = d == null ? void 0 : d.series) == null ? void 0 : u.dataLabels, (p = d == null ? void 0 : d[c.type]) == null ? void 0 : p.dataLabels), c.options.dataLabels));
        }
      ...
      let kr = _, { composed: sf } = E, { series: Ol } = Lt, { merge: rf, pushUnique: of } = V;
      (function(h) {
        function t(e, i, s, r, o) {
          ...
          if (u) {
            if (r = rf(u), s.overflow !== "allow" || s.crop !== !1 || n.clip !== !1) {
          ...
          s.align ?? (s.align = !l || g ? "center" : p ? "right" : "left"), s.verticalAlign ?? (s.verticalAlign = l || g ? "middle" : p ? "top" : "bottom"), Ol.prototype.alignDataLabel.call(this, e, i, s, r, o), s.inside && e.contrastColor && i.css({ color: e.contrastColor });
        }
        h.compose = function(e) {
          kr.compose(Ol), of(sf, "ColumnDataLabel") && (e.prototype.alignDataLabel = t);
        };
      })(ft || (ft = {}));
      let af = ft, { extend: nf, merge: lf } = V;
      class Ko extends wr {
      }
      Ko.defaultOptions = lf(wr.defaultOptions, {}), nf(Ko.prototype, { inverted: !0 }), Lt.registerSeriesType("bar", Ko);
      let { column: hf, line: Pl } = Lt.seriesTypes, { addEvent: df, extend: cf, merge: uf } = V;
      class Sr extends Pl {
        applyJitter() {
      ...
      Sr.defaultOptions = uf(Pl.defaultOptions, { lineWidth: 0, findNearestPointBy: "xy", jitter: { x: 0, y: 0 }, marker: { enabled: !0 }, tooltip: { headerFormat: '<span style="color:{point.color}">●</span> <span style="font-size: 0.8em"> {series.name}</span><br/>', pointFormat: "x: <b>{point.x}</b><br/>y: <b>{point.y}</b><br/>" } }), cf(Sr.prototype, { drawTracker: hf.prototype.drawTracker, sorted: !1, requireSorting: !1, noSharedTooltip: !0, trackerGroups: ["group", "markerGroup", "dataLabelsGroup"] }), df(Sr, "afterTranslate", function() {
        this.applyJitter();
      }), Lt.registerSeriesType("scatter", Sr);
      let { deg2rad: Ll } = E, { fireEvent: pf, isNumber: Qo, pick: Mr, relativeLength: ff } = V;
      (function(h) {
        h.getCenter = function() {
          ...
          for (!e.angular || this instanceof ie || (g[3] = 0), u = 0; u < 4; ++u) p = g[u], l = u < 2 || u === 2 && /%$/.test(p), g[u] = ff(p, [s, r, a, g[2]][u]) + (l ? i : 0);
          return g[3] > g[2] && (g[3] = g[2]), Qo(n) && 2 * n < g[2] && n > 0 && (g[3] = g[2] - 2 * n), pf(this, "afterGetCenter", { positions: g }), g;
        }, h.getStartAndEndRadians = function(t, e) {
          let i = Qo(t) ? t : 0, s = Qo(e) && e > i && e - i < 360 ? e : i + 360;
          return { start: Ll * (i + -90), end: Ll * (s + -90) };
        };
      })(H || (H = {}));
      let El = H, { setAnimation: gf } = Xt, { addEvent: Il, defined: mf, extend: yf, isNumber: xf, pick: bf, relativeLength: vf } = V;
      class Rl extends je {
        getConnectorPath(t) {
        ...
        constructor(t, e, i) {
          ...
          Il(this, "select", s), Il(this, "unselect", s);
        }
        isValid() {
          return xf(this.y) && this.y >= 0;
        }
        setVisible(t, e = !0) {
        ...
        slice(t, e, i) {
          let s = this.series;
          gf(i, s.chart), e = bf(e, !0), this.sliced = this.options.sliced = t = mf(t) ? t : !this.sliced, s.options.data[s.data.indexOf(this)] = this.options, this.graphic && this.graphic.animate(this.getTranslate());
        }
      }
      yf(Rl.prototype, { connectorShapes: { fixedOffset: function(h, t, e) {
      ...
      let { getStartAndEndRadians: wf } = El, { noop: Dl } = E, { clamp: kf, extend: Sf, fireEvent: Bl, merge: _o, pick: Mf } = V;
      class Zo extends ie {
        animate(t) {
          let e = this, i = e.points, s = e.startAngleRad;
          t || i.forEach(function(r) {
            let o = r.graphic, a = r.shapeArgs;
            o && a && (o.attr({ r: Mf(r.startR, e.center && e.center[3] / 2), start: s, end: s }), o.animate({ r: a.r, start: a.start, end: a.end }, e.options.animation));
          });
        }
        drawEmpty() {
          let t, e, i = this.startAngleRad, s = this.endAngleRad, r = this.options;
          this.total === 0 && this.center ? (t = this.center[0], e = this.center[1], this.graph || (this.graph = this.chart.renderer.arc(t, e, this.center[1] / 2, 0, i, s).addClass("highcharts-empty-series").add(this.group)), this.graph.attr({ d: ln.arc(t, e, this.center[2] / 2, 0, { start: i, end: s, innerR: this.center[3] / 2 }) }), this.chart.styledMode || this.graph.attr({ "stroke-width": r.borderWidth, fill: r.fillColor || "none", stroke: r.color || "#cccccc" })) : this.graph && (this.graph = this.graph.destroy());
        }
        drawPoints() {
        ...
        getX(t, e, i, s) {
          let r = this.center, o = this.radii ? this.radii[i.index] || 0 : r[2] / 2, a = s.dataLabelPosition, n = (a == null ? void 0 : a.distance) || 0, l = Math.asin(kf((t - r[1]) / (o + n), -1, 1));
        ...
        translate(t) {
          Bl(this, "translate"), this.generatePoints();
          let e = this.options, i = e.slicedOffset, s = wf(e.startAngle, e.endAngle), r = this.startAngleRad = s.start, o = (this.endAngleRad = s.end) - r, a = this.points, n = e.ignoreHiddenPoint, l = a.length, c, d, u, p, g, x, y, m = 0;
      ...
      Zo.defaultOptions = _o(ie.defaultOptions, { borderRadius: 3, center: [null, null], clip: !1, colorByPoint: !0, dataLabels: { connectorPadding: 5, connectorShape: "crookedLine", crookDistance: void 0, distance: 30, enabled: !0, formatter: function() {
        return this.isNull ? void 0 : this.name;
      }, softConnector: !0, x: 0 }, fillColor: void 0, ignoreHiddenPoint: !0, inactiveOtherPoints: !0, legendType: "point", marker: null, size: null, showInLegend: !1, slicedOffset: 10, stickyTracking: !1, tooltip: { followPointer: !0 }, borderColor: "#ffffff", borderWidth: 1, lineWidth: void 0, states: { hover: { brightness: 0.1 } } }), Sf(Zo.prototype, { axisTypes: [], directTouch: !0, drawGraph: void 0, drawTracker: wr.prototype.drawTracker, getCenter: El.getCenter, getSymbol: Dl, invertible: !1, isCartesian: !1, noSharedTooltip: !0, pointAttribs: wr.prototype.pointAttribs, pointClass: Rl, requireSorting: !1, searchPoint: Dl, trackerGroups: ["group", "dataLabelsGroup"] }), Lt.registerSeriesType("pie", Zo);
      let { composed: Cf, noop: Tf } = E, { distribute: Af } = Ws, { series: Nl } = Lt, { arrayMax: Of, clamp: zl, defined: Fl, pick: Pf, pushUnique: Lf, relativeLength: Wl } = V;
      (function(h) {
        ...
        function i() {
          ...
          o.visible && ((P = o.hasDataLabels) != null && P.call(o)) && (a.forEach((A) => {
          ...
          }), Nl.prototype.drawDataLabels.apply(o), a.forEach((A) => {
            (A.dataLabels || []).forEach((L, R) => {
              var X;
              let D = p[2] / 2, N = L.options, B = Wl((N == null ? void 0 : N.distance) || 0, D);
              R === 0 && y[A.half].push(A), !Fl((X = N == null ? void 0 : N.style) == null ? void 0 : X.width) && L.getBBox().width > u && (L.css({ width: Math.round(0.7 * u) + "px" }), L.shortened = !0), L.dataLabelPosition = this.getDataLabelPosition(A, B), M = Math.max(M, B);
            });
          }), y.forEach((A, L) => {
            ...
            R && (o.sortByAngle(A, L - 0.5), M > 0 && (N = Math.max(0, x - g - M), B = Math.min(x + g + M, n.plotHeight), A.forEach((it) => {
              ...
              (it.dataLabels || []).forEach((G) => {
                ...
                if (dt) {
                  if (D && Fl(ct) && dt.distance > 0 && (ct.pos === void 0 ? Rt = "hidden" : (S = ct.size, Q = v.radialDistributionY(it, G))), et.justify) ot = v.justify(it, G, g, p);
                  ...
                  if (dt.attribs = { visibility: Rt, align: dt.alignment }, dt.posAttribs = { x: ot + (et.x || 0) + ({ left: Yt, right: -Yt }[dt.alignment] || 0), y: Q + (et.y || 0) - ut / 2 }, dt.computed.x = ot, dt.computed.y = Q - bt, Pf(et.crop, !0)) {
                    let vt;
          ...
          }), (Of(m) === 0 || this.verifyDataLabelOverflow(m)) && (this.placeDataLabels(), this.points.forEach((A) => {
            (A.dataLabels || []).forEach((L) => {
              var B;
        ...
        function r(o) {
          ...
          return !u && (l[0] !== null ? d = Math.max(a[2] - Math.max(o[1], o[3]), c) : (d = Math.max(a[2] - o[1] - o[3], c), a[0] += (o[3] - o[1]) / 2), l[1] !== null ? d = zl(d, c, a[2] - Math.max(o[0], o[2])) : (d = zl(d, c, a[2] - o[0] - o[2]), a[1] += (o[0] - o[2]) / 2), d < a[2] ? (a[2] = d, a[3] = Math.min(n.thickness ? Math.max(0, d - 2 * n.thickness) : Math.max(0, Wl(n.innerSize || 0, d)), d), this.translate(a), this.drawDataLabels && this.drawDataLabels()) : u = !0), u;
        }
        h.compose = function(o) {
          if (kr.compose(Nl), Lf(Cf, "PieDataLabel")) {
            let a = o.prototype;
            a.dataLabelPositioners = t, a.alignDataLabel = Tf, a.drawDataLabels = i, a.getDataLabelPosition = e, a.placeDataLabels = s, a.verifyDataLabelOverflow = r;
          }
        };
      })(tt || (tt = {}));
      let Ef = tt;
      ...
      let { pointInPolygon: If } = ht, { addEvent: Rf, getAlignFactor: Df, fireEvent: Hl, objectEach: jl, pick: Bf } = V;
      function Nf(h) {
        let t = h.length, e = (c, d) => !(d.x >= c.x + c.width || d.x + d.width <= c.x || d.y >= c.y + c.height || d.y + d.height <= c.y), i = (c, d) => {
          for (let u of c) if (If({ x: u[0], y: u[1] }, d)) return !0;
          return !1;
        }, s, r, o, a, n, l = !1;
        for (let c = 0; c < t; c++) (s = h[c]) && (s.oldOpacity = s.opacity, s.newOpacity = 1, s.absoluteBox = function(d) {
          var u, p;
          if (d && (!d.alignAttr || d.placed)) {
            let g = d.box ? 0 : d.padding || 0, x = d.alignAttr || { x: d.attr("x"), y: d.attr("y") }, { height: y, polygon: m, width: v } = d.getBBox(), w = Df(d.alignValue) * v;
        ...
        for (let c of h) Xl(c, this) && (l = !0);
        l && Hl(this, "afterHideAllOverlappingLabels");
      }
      function Xl(h, t) {
        let e, i = !1;
        ...
        }), Hl(t, "afterHideOverlappingLabel")) : h.attr({ opacity: e })), h.isOld = !0), i;
      }
      function zf() {
        var e;
        let h = this, t = [];
        for (let i of h.labelCollectors || []) t = t.concat(i());
        for (let i of h.yAxis || []) i.stacking && i.options.stackLabels && !i.options.stackLabels.allowOverlap && jl(i.stacking.stacks, (s) => {
          jl(s, (r) => {
        ...
        for (let i of h.series || []) if (i.visible && ((e = i.hasDataLabels) != null && e.call(i))) {
          let s = (r) => {
            for (let o of r) o.visible && (o.dataLabels || []).forEach((a) => {
              var l;
              let n = a.options || {};
              a.labelrank = Bf(n.labelrank, o.labelrank, (l = o.shapeArgs) == null ? void 0 : l.height), n.allowOverlap ?? Number(n.distance) > 0 ? (a.oldOpacity = a.opacity, a.newOpacity = 1, Xl(a, h)) : t.push(a);
            });
          };
      ...
      let Gl = { compose: function(h) {
        let t = h.prototype;
        t.hideOverlappingLabels || (t.hideOverlappingLabels = Nf, Rf(h, "render", zf));
      } }, { defaultOptions: Ff } = re, { noop: Yl } = E, { addEvent: Ul, extend: Wf, isObject: ql, merge: Hf, relativeLength: Jo } = V, jf = { radius: 0, scope: "stack", where: void 0 }, $l = Yl, Vl = Yl;
      function Xf(h, t, e, i, s = {}) {
        let r = $l(h, t, e, i, s), { innerR: o = 0, r: a = e, start: n = 0, end: l = 0 } = s;
        if (s.open || !s.borderRadius) return r;
        let c = l - n, d = Math.sin(c / 2), u = Math.max(Math.min(Jo(s.borderRadius || 0, a - o), (a - o) / 2, a * d / (1 + d)), 0), p = Math.min(u, c / Math.PI * 2 * o), g = r.length - 1;
      ...
      function Gf() {
        ...
        if (this.options.borderRadius && !(this.chart.is3d && this.chart.is3d())) {
          let { options: e, yAxis: i } = this, s = e.stacking === "percent", r = (t = (h = Ff.plotOptions) == null ? void 0 : h[this.type]) == null ? void 0 : t.borderRadius, o = ta(e.borderRadius, ql(r) ? r : {}), a = i.options.reversed;
          for (let n of this.points) {
            ...
            if (n.shapeType === "roundedRect" && l) {
              ...
              let m = Math.min(Jo(o.radius, c), c / 2, y === "all" ? d / 2 : 1 / 0) || 0;
              y === "end" && (x && (p -= m), g += m), Wf(l, { brBoxHeight: g, brBoxY: p, r: m });
            }
          }
        }
      }
      function ta(h, t) {
        return ql(h) || (h = { radius: h || 0 }), Hf(jf, t, h);
      }
      function Yf() {
        let h = ta(this.options.borderRadius);
        for (let t of this.points) {
          let e = t.shapeArgs;
          e && (e.borderRadius = Jo(h.radius, (e.r || 0) - (e.innerR || 0)));
        }
      }
      function Uf(h, t, e, i, s = {}) {
        let r = Vl(h, t, e, i, s), { r: o = 0, brBoxHeight: a = i, brBoxY: n = t } = s, l = t - n, c = n + a - (t + i), d = l - o > -0.1 ? 0 : o, u = c - o > -0.1 ? 0 : o, p = Math.max(d && l, 0), g = Math.max(u && c, 0), x = [h + d, t], y = [h + e - d, t], m = [h + e, t + d], v = [h + e, t + i - u], w = [h + e - u, t + i], T = [h + u, t + i], S = [h, t + i - u], M = [h, t + d], P = (A, L) => Math.sqrt(Math.pow(A, 2) - Math.pow(L, 2));
        if (p) {
          let A = P(d, d - p);
      ...
      let { diffObjects: qf, extend: $f, find: Vf, merge: Kf, pick: Cr, uniqueKey: Qf } = V;
      (function(h) {
        function t(i, s) {
          let r = i.condition;
          (r.callback || function() {
        ...
        function e(i, s) {
          ...
          !s && r && r.rules && r.rules.forEach((d) => {
            d._id === void 0 && (d._id = Qf()), this.matchResponsiveRule(d, a);
          }, this);
          let l = Kf(...a.map((d) => Vf((r == null ? void 0 : r.rules) || [], (u) => u._id === d)).map((d) => d == null ? void 0 : d.chartOptions));
          l.isResponsiveOptions = !0, a = a.toString() || void 0;
          let c = o == null ? void 0 : o.ruleIds;
          a === c || (o && (this.currentResponsive = void 0, this.updatingResponsive = !0, this.update(o.undoOptions, i, !0), this.updatingResponsive = !1), a ? ((n = qf(l, this.options, !0, this.collectionsWithUpdate)).isResponsiveOptions = !0, this.currentResponsive = { ruleIds: a, mergedOptions: l, undoOptions: n }, this.updatingResponsive || this.update(l, i, !0)) : this.currentResponsive = void 0);
        }
        h.compose = function(i) {
          let s = i.prototype;
          return s.matchResponsiveRule || $f(s, { matchResponsiveRule: t, setResponsive: e }), i;
        };
      })(xt || (xt = {}));
      let _f = xt;
      E.AST = Tt, E.Axis = Di, E.Chart = Ue, E.Color = At, E.DataLabel = kr, E.DataTableCore = lr, E.Fx = Kt, E.HTMLElement = Ii, E.Legend = il, E.LegendSymbol = Xn, E.OverlappingDataLabels = E.OverlappingDataLabels || Gl, E.PlotLineOrBand = sr, E.Point = je, E.Pointer = Wn, E.RendererRegistry = os, E.Series = ie, E.SeriesRegistry = Lt, E.StackItem = fl, E.SVGElement = we, E.SVGRenderer = $s, E.Templating = oe, E.Tick = Ri, E.Time = Xr, E.Tooltip = Dn, E.animate = Xt.animate, E.animObject = Xt.animObject, E.chart = Ue.chart, E.color = At.parse, E.dateFormat = oe.dateFormat, E.defaultOptions = re.defaultOptions, E.distribute = Ws.distribute, E.format = oe.format, E.getDeferredAnimation = Xt.getDeferredAnimation, E.getOptions = re.getOptions, E.numberFormat = oe.numberFormat, E.seriesType = Lt.seriesType, E.setAnimation = Xt.setAnimation, E.setOptions = re.setOptions, E.stop = Xt.stop, E.time = re.defaultTime, E.timers = Kt.timers, { compose: function(h, t, e) {
        let i = h.types.pie;
        if (!t.symbolCustomAttribs.includes("borderRadius")) {
          let s = e.prototype.symbols;
          Ul(h, "afterColumnTranslate", Gf, { order: 9 }), Ul(i, "afterTranslate", Yf), t.symbolCustomAttribs.push("borderRadius", "brBoxHeight", "brBoxY"), $l = s.arc, Vl = s.roundedRect, s.arc = Xf, s.roundedRect = Uf;
        }
      }, optionsToObject: ta }.compose(E.Series, E.SVGElement, E.SVGRenderer), af.compose(E.Series.types.column), kr.compose(E.Series), Wc.compose(E.Axis), Ii.compose(E.SVGRenderer), il.compose(E.Chart), Xc.compose(E.Axis), Gl.compose(E.Chart), Ef.compose(E.Series.types.pie), sr.compose(E.Chart, E.Axis), Wn.compose(E.Chart), _f.compose(E.Chart), ms.compose(E.Axis, E.Chart, E.Series), Fp.compose(E.Axis, E.Chart, E.Series), Dn.compose(E.Pointer), V.extend(E, V);
      let Zf = E;
      return pe.default;
    })());
  }(Ir)), Ir.exports;
...
var am = om();
const nm = /* @__PURE__ */ Mh(am);
var Rr = { exports: {} }, lm = Rr.exports, ph;
function hm() {
  return ph || (ph = 1, function(b, f) {
    (function(k, C) {
      b.exports = C(Br);
    })(typeof self < "u" ? self : lm, function(k) {
      return function(C) {
        function I(z) {
...
var dm = hm();
const cm = /* @__PURE__ */ Mh(dm), fh = ({ series: b }) => {
  const f = im(b);
  ...
  const { isLoading: b, data: f = null } = tm({
  ...
  const { onlineSeriesList: k, offlineSeriesList: C } = sm(f);
  return /* @__PURE__ */ te.jsxs("div", { className: "chart-container", children: [
    /* @__PURE__ */ te.jsxs("div", { className: "chart-wrapper", children: [
      ...
      /* @__PURE__ */ te.jsx(fh, { series: k })
    ] }),
    /* @__PURE__ */ te.jsxs("div", { className: "chart-wrapper", children: [
      /* @__PURE__ */ te.jsx("h3", { className: "chart-title", children: "Offline Sites" }),
      /* @__PURE__ */ te.jsx(fh, { series: C })
    ] })
  ] });
}, fm = () => /* @__PURE__ */ te.jsx(jg, { client: um, children: /* @__PURE__ */ te.jsx(pm, {}) }), gm = fg(fm, {
  shadow: "closed"
});
customElements.define("site-overview-chart", gm);
